...
BEGIN
    ...
    BEGIN
        ...
        SELECT d.[DocumentId]
        FROM inserted d
        INNER JOIN deleted old ON old.[DocumentId] = d.[DocumentId]
        WHERE (d.[GradeTypeDescriptor_DescriptorId] <> old.[GradeTypeDescriptor_DescriptorId] OR (d.[GradeTypeDescriptor_DescriptorId] IS NULL AND old.[GradeTypeDescriptor_DescriptorId] IS NOT NULL) OR (d.[GradeTypeDescriptor_DescriptorId] IS NOT NULL AND old.[GradeTypeDescriptor_DescriptorId] IS NULL)) OR (d.[GradingPeriodGradingPeriod_GradingPeriodDescriptor_DescriptorId] <> old.[GradingPeriodGradingPeriod_GradingPeriodDescriptor_DescriptorId] OR (d.[GradingPeriodGradingPeriod_GradingPeriodDescriptor_DescriptorId] IS NULL AND old.[GradingPeriodGradingPeriod_GradingPeriodDescriptor_DescriptorId] IS NOT NULL) OR (d.[GradingPeriodGradingPeriod_GradingPeriodDescriptor_DescriptorId] IS NOT NULL AND old.[GradingPeriodGradingPeriod_GradingPeriodDescriptor_DescriptorId] IS NULL)) OR (CAST(d.[GradingPeriodGradingPeriod_GradingPeriodName] AS varbinary(max)) <> CAST(old.[GradingPeriodGradingPeriod_GradingPeriodName] AS varbinary(max)) OR (d.[GradingPeriodGradingPeriod_GradingPeriodName] IS NULL AND old.[GradingPeriodGradingPeriod_GradingPeriodName] IS NOT NULL) OR (d.[GradingPeriodGradingPeriod_GradingPeriodName] IS NOT NULL AND old.[GradingPeriodGradingPeriod_GradingPeriodName] IS NULL)) OR (d.[SchoolId_Unified] <> old.[SchoolId_Unified] OR (d.[SchoolId_Unified] IS NULL AND old.[SchoolId_Unified] IS NOT NULL) OR (d.[SchoolId_Unified] IS NOT NULL AND old.[SchoolId_Unified] IS NULL)) OR (d.[SchoolYear_Unified] <> old.[SchoolYear_Unified] OR (d.[SchoolYear_Unified] IS NULL AND old.[SchoolYear_Unified] IS NOT NULL) OR (d.[SchoolYear_Unified] IS NOT NULL AND old.[SchoolYear_Unified] IS NULL)) OR (d.[StudentSectionAssociation_BeginDate] <> old.[StudentSectionAssociation_BeginDate] OR (d.[StudentSectionAssociation_BeginDate] IS NULL AND old.[StudentSectionAssociation_BeginDate] IS NOT NULL) OR (d.[StudentSectionAssociation_BeginDate] IS NOT NULL AND old.[StudentSectionAssociation_BeginDate] IS NULL)) OR (CAST(d.[StudentSectionAssociation_LocalCourseCode] AS varbinary(max)) <> CAST(old.[StudentSectionAssociation_LocalCourseCode] AS varbinary(max)) OR (d.[StudentSectionAssociation_LocalCourseCode] IS NULL AND old.[StudentSectionAssociation_LocalCourseCode] IS NOT NULL) OR (d.[StudentSectionAssociation_LocalCourseCode] IS NOT NULL AND old.[StudentSectionAssociation_LocalCourseCode] IS NULL)) OR (CAST(d.[StudentSectionAssociation_SectionIdentifier] AS varbinary(max)) <> CAST(old.[StudentSectionAssociation_SectionIdentifier] AS varbinary(max)) OR (d.[StudentSectionAssociation_SectionIdentifier] IS NULL AND old.[StudentSectionAssociation_SectionIdentifier] IS NOT NULL) OR (d.[StudentSectionAssociation_SectionIdentifier] IS NOT NULL AND old.[StudentSectionAssociation_SectionIdentifier] IS NULL)) OR (CAST(d.[StudentSectionAssociation_SessionName] AS varbinary(max)) <> CAST(old.[StudentSectionAssociation_SessionName] AS varbinary(max)) OR (d.[StudentSectionAssociation_SessionName] IS NULL AND old.[StudentSectionAssociation_SessionName] IS NOT NULL) OR (d.[StudentSectionAssociation_SessionName] IS NOT NULL AND old.[StudentSectionAssociation_SessionName] IS NULL)) OR (CAST(d.[StudentSectionAssociation_StudentUniqueId] AS varbinary(max)) <> CAST(old.[StudentSectionAssociation_StudentUniqueId] AS varbinary(max)) OR (d.[StudentSectionAssociation_StudentUniqueId] IS NULL AND old.[StudentSectionAssociation_StudentUniqueId] IS NOT NULL) OR (d.[StudentSectionAssociation_StudentUniqueId] IS NOT NULL AND old.[StudentSectionAssociation_StudentUniqueId] IS NULL));
