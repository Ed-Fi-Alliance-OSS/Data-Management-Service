...
- Hard dependencies: completed E20-S02 through E20-S08b behavior plus the E20-S09 harness and
  baseline artifacts.
...
- Provision the epic's narrow fixture set: the smoke set, the single 500,000-row primary fixture
  ...
  than loading separate large data sets, and reuse the E20-S09 fixture definition so the
