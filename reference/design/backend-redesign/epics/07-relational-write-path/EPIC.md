...
- `TBD` — `01a-c2-semantic-identity-compatibility-validation.md` — Semantic Identity Compatibility Validation (Core, Tier 0)
...
- `TBD` — `01a-c4-request-creatability-and-collection-validation.md` — Request-Side Creatability Analysis + Duplicate Collection-Item Validation (Core, Tier 1)
- `TBD` — `01a-c5-assemble-profile-applied-write-request.md` — Assemble ProfileAppliedWriteRequest (Core, Tier 1)
- `TBD` — `01a-c6-stored-state-projection-and-hidden-member-paths.md` — Stored-State Projection + HiddenMemberPaths Computation (Core, Tier 2)
