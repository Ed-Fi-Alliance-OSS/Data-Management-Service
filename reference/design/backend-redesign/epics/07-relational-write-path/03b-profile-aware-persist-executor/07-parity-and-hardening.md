...
- DMS-1258 dependent anchor-bearing profile fixture on both providers: hidden reference preserves its full stored tuple,
  visible-absent clears the optional tuple, visible retarget replaces public values plus demanded anchors atomically, and
  guarded no-op comparison observes the anchor columns
