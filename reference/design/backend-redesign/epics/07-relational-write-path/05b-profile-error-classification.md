...
- Unit or integration tests cover representative cases for invalid usage, forbidden submitted data, `ProfileRootCreateRejectedWhenNonCreatable`, `ProfileVisibleScopeOrItemInsertRejectedWhenNonCreatable`, and the required update-allowed/create-denied pairing from the shared profile scenario matrix.
