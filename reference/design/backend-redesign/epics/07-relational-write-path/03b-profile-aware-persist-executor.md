...
4. Extend the shared no-op comparison path to support profile-applied rowset synthesis, including `ProfileUnchangedWriteGuardedNoOp`, without introducing a profile-only compare implementation.
