...
- Introspection manifest includes (at minimum):
  ...
  - singleton `dms.DocumentCacheState` presence with the cache-ahead recovery latch clear
    on first apply; the smoke sets the latch before reapply and proves reapply preserves it.
