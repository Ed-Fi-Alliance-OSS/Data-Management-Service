...
- `reference/design/backend-redesign/design-docs/update-tracking.md` (stored stamps for `_lastModifiedDate/ChangeVersion`, composed `_etag` from `ContentVersion` plus `variantKey`)
