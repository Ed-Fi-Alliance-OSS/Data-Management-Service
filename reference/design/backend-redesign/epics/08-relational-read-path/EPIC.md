...
- `reference/design/backend-redesign/data-model.md` (abstract union views, descriptor model)
- `reference/design/backend-redesign/extensions.md` (read-time `_ext` overlay)
- `reference/design/backend-redesign/update-tracking.md` (derived metadata dependencies)
...
- `02-reference-identity-projection.md` — Project reference identity fields (incl. abstract targets via union views)
