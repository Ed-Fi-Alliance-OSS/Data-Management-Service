...
- Benefits from `18-03-async-projector-worker.md` but must behave correctly when the projector is behind or
  disabled.
...
4. Add fallback and projection-enqueue behavior for misses/stale rows.
