...
- Add runtime integration tests for write/read/delete correctness using the new relational backend, including profile-constrained write semantics.
- Maintain pgsql + mssql parity testing for baseline CRUD and profile-constrained scenarios where applicable.
...
- `DMS-1022` — `01-backend-integration-tests.md` — CRUD + profile integration tests against provisioned DBs (pgsql + mssql)
