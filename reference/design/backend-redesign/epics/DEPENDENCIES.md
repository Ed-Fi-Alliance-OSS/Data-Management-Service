...
- `E20` reuses E08 page selection/hydration, E10 live change-version filters, and E14 row-level
  authorization, and extends the E15 plan-SQL foundations plus the plan-contract and
  deterministic-binding artifacts that own `PageDocumentIdSqlCompiler` and `PageDocumentIdSql`,
  whose canonicalized/golden output must stay stable. E12 benchmarks and E13 parity/E2E
  infrastructure are soft delivery inputs.
...
| E20 | [Partitioned Cursor Paging](20-partitioned-cursor-paging/EPIC.md) | E08, E10, E14, E15 | ODS-compatible cursor GET-many paging, authorized partition boundaries, OpenAPI, parity, and performance evidence |
...
| E02-S07 | [`07-stable-collection-row-identity-ddl.md`](02-ddl-emission/07-stable-collection-row-identity-ddl.md) | E01-S11, E02-S01, E02-S02 | E02-S04 | `CollectionItemId`-based collection/common-type DDL + sequence/constraint updates |
...
| Story | Title | Hard Depends On | Soft Depends On | Produces / Touches |
| --- | --- | --- | --- | --- |
| E03-S00 | [`00-ddl-emit-command.md`](03-provisioning-workflow/00-ddl-emit-command.md) | E00-S04, E01-S05, E02-S01–E02-S04, E02-S06, E02-S07 | — | CLI outputs: `{dialect}.sql` + manifests (no DB required) |
...
| E07-S01a-C3 | [`01a-c3-request-visibility-and-writable-shaping.md`](07-relational-write-path/01a-c3-request-visibility-and-writable-shaping.md) | E07-S01a-C1, E07-S01a-C8 | — | Request-side visibility classification + writable request shaping (Core, Tier 1) |
| E07-S01a-C4 | [`01a-c4-request-creatability-and-collection-validation.md`](07-relational-write-path/01a-c4-request-creatability-and-collection-validation.md) | E07-S01a-C1, E07-S01a-C2, E07-S01a-C3, E07-S01a-C8 | — | Request-side creatability + duplicate collection-item validation (Core, Tier 2) |
| E07-S01a-C5 | [`01a-c5-assemble-profile-applied-write-request.md`](07-relational-write-path/01a-c5-assemble-profile-applied-write-request.md) | E07-S01a-C1, E07-S01a-C2, E07-S01a-C3, E07-S01a-C4, E07-S01a-C8 | — | Orchestrate profile write pipeline + assemble `ProfileAppliedWriteRequest` (Core, Tier 2) |
| E07-S01a-C6 | [`01a-c6-stored-state-projection-and-hidden-member-paths.md`](07-relational-write-path/01a-c6-stored-state-projection-and-hidden-member-paths.md) | E07-S01a-C1, E07-S01a-C3, E07-S01a-C5 | — | Stored-state projection + `HiddenMemberPaths` + `ProfileAppliedWriteContext` assembly (Core, Tier 3) |
| E07-S01a-C7 | [`01a-c7-readable-profile-projection.md`](07-relational-write-path/01a-c7-readable-profile-projection.md) | E07-S01a | — | Readable profile projection after reconstitution (Core, no C-story dependencies — can start immediately) |
...
| E08-S01 | [`01-json-reconstitution.md`](08-relational-read-path/01-json-reconstitution.md) | E08-S00, E07-S01a-C7 | — | JSON writer/reconstituter (ordering, null handling, `_ext` overlay) |
...
Jira keys. E20-S00a owns the typed contracts, codec, and configuration that E20-S00b's validators
consume. E20-S09 owns the harness and pre-change traditional baseline and must complete before
E20-S03 modifies the shared page-selection compiler; because E20-S03 keeps traditional
page-selection output behaviorally and textually unchanged, that baseline is regression insurance
over the shared compiler rather than a record of an expected change. E20-S02 may proceed in parallel
because it extends the existing shared plan contract. The E20-S03 dependency makes the baseline
precede downstream shared-execution changes in E20-S04 and E20-S05, the first of which actually
alters shared traditional runtime execution. E20-S06 boundary-compiler and SQL-golden work requires
E20-S00a through E20-S03, while route activation additionally requires E20-S04 and E20-S05.
E20-S10 is a separate final gate that consumes E20-S02 through E20-S09, E20-S11 owns the ODS fixture
and case definitions whose DMS side executes in E20-S08b, and E20-S12 owns independently sequenced
...
| E20-S00b | [`00b-cursor-and-partition-validation.md`](20-partitioned-cursor-paging/00b-cursor-and-partition-validation.md) | E20-S00a | — | Cursor precedence validation, partition validation, ProblemDetails shell, operation-scoped rejection |
| E20-S01 | [`01-typed-resource-path-operations.md`](20-partitioned-cursor-paging/01-typed-resource-path-operations.md) | E20-S00b | — | Typed path operations, query canonicalization, routing regressions |
| E20-S02 | [`02-shared-candidate-planning.md`](20-partitioned-cursor-paging/02-shared-candidate-planning.md) | E20-S00a | E08-S04, E08-S05, E10, E14, E15-S01, E15-S02 | Extended shared page-document-id plan, Core filter sharing, and uniqueness assertion |
| E20-S03 | [`03-provider-cursor-sql.md`](20-partitioned-cursor-paging/03-provider-cursor-sql.md) | E20-S00a, E20-S02, E20-S09 | E15-S01, E15-S02 | PostgreSQL/SQL Server cursor SQL and plan goldens |
| E20-S04 | [`04-regular-resource-cursor-execution.md`](20-partitioned-cursor-paging/04-regular-resource-cursor-execution.md) | E20-S00a–E20-S03 | — | Regular-resource keyset boundary propagation and response header |
| E20-S05 | [`05-descriptor-cursor-execution.md`](20-partitioned-cursor-paging/05-descriptor-cursor-execution.md) | E20-S00a–E20-S03 | — | Descriptor boundary propagation and response header |
| E20-S06 | [`06-partition-pipeline-and-sql.md`](20-partitioned-cursor-paging/06-partition-pipeline-and-sql.md) | E20-S00a–E20-S03 | E20-S04, E20-S05 (hard for route activation) | Boundary compiler requires S00a–S03; activated dedicated pipeline also requires S04/S05 |
...
| E20-S08b | [`08b-public-contract-parity-and-e2e.md`](20-partitioned-cursor-paging/08b-public-contract-parity-and-e2e.md) | E20-S04–E20-S07, E20-S11 | E20-S08a | Public contract coverage, DMS-side parity execution, and E2E evidence |
...
| E20-S11 | [`11-ods-parity-fixture-and-difference-ledger.md`](20-partitioned-cursor-paging/11-ods-parity-fixture-and-difference-ledger.md) | E20-S00b | E13 | Pinned ODS 7.3.2 stack, case definitions, ODS-side capture, and approved-difference ledger |
...
7. DMS-983/DMS-984 split: E07-S00 → E07-S01 → E07-S02 for the backend flattener thin slice, then E07-S03 after E07-S02 + E15-S04b for the shared/no-profile persist foundation; in parallel, E07-S01a → (E07-S01a-C1 + E07-S01a-C8) → E07-S01a-C3 → E07-S01a-C4 → E07-S01a-C5 → E07-S01a-C6 → E07-S01b → E07-S02b and E07-S01c for profile hand-off/current-state work; E07-S03b then waits on E07-S03, E07-S02b, and E07-S01c before continuing to E07-S05b and full profile test coverage
...
- **Write vs read**: E07 and E08 can proceed in parallel once E06 provides mapping sets and E15 has produced the required write/read plan compilers; profiled writes do not need the public read pipeline
...
| Hard | `E07-S01a-C1` | `DMS-1111` | `07-relational-write-path/01a-c1-compiled-scope-adapter-and-address-derivation.md` | `E07-S01b` | `DMS-1106` | `07-relational-write-path/01b-profile-write-context.md` |
| Hard | `E07-S01a-C5` | `DMS-1117` | `07-relational-write-path/01a-c5-assemble-profile-applied-write-request.md` | `E07-S01b` | `DMS-1106` | `07-relational-write-path/01b-profile-write-context.md` |
| Hard | `E07-S01a-C6` | `DMS-1118` | `07-relational-write-path/01a-c6-stored-state-projection-and-hidden-member-paths.md` | `E07-S01b` | `DMS-1106` | `07-relational-write-path/01b-profile-write-context.md` |
| Hard | `E07-S01a-C8` | `DMS-1112` | `07-relational-write-path/01a-c8-typed-profile-error-classification.md` | `E07-S01b` | `DMS-1106` | `07-relational-write-path/01b-profile-write-context.md` |
| Hard | `E15-S04b` | `DMS-1108` | `15-plan-compilation/04b-stable-collection-merge-plans.md` | `E07-S01b` | `DMS-1106` | `07-relational-write-path/01b-profile-write-context.md` |
...
| Hard | `E07-S01a-C1` | `DMS-1111` | `07-relational-write-path/01a-c1-compiled-scope-adapter-and-address-derivation.md` | `E07-S01c` | `DMS-1105` | `07-relational-write-path/01c-current-document-for-profile-projection.md` |
| Hard | `E07-S01a-C6` | `DMS-1118` | `07-relational-write-path/01a-c6-stored-state-projection-and-hidden-member-paths.md` | `E07-S01c` | `DMS-1105` | `07-relational-write-path/01c-current-document-for-profile-projection.md` |
| Hard | `E07-S01b` | `DMS-1106` | `07-relational-write-path/01b-profile-write-context.md` | `E07-S01c` | `DMS-1105` | `07-relational-write-path/01c-current-document-for-profile-projection.md` |
...
| Soft | `E01-S11` | `DMS-1103` | `01-relational-model/11-stable-collection-row-identity.md` | `E07-S02` | `DMS-983` | `07-relational-write-path/02-flattening-executor.md` |
...
| Hard | `E07-S03` | `DMS-984` | `07-relational-write-path/03-persist-and-batch.md` | `E07-S03b` | `DMS-1124` | `07-relational-write-path/03b-profile-aware-persist-executor.md` |
| Hard | `E07-S01b` | `DMS-1106` | `07-relational-write-path/01b-profile-write-context.md` | `E07-S03b` | `DMS-1124` | `07-relational-write-path/03b-profile-aware-persist-executor.md` |
| Hard | `E07-S01c` | `DMS-1105` | `07-relational-write-path/01c-current-document-for-profile-projection.md` | `E07-S03b` | `DMS-1124` | `07-relational-write-path/03b-profile-aware-persist-executor.md` |
| Hard | `E07-S02b` | `DMS-1123` | `07-relational-write-path/02b-profile-applied-request-flattening.md` | `E07-S03b` | `DMS-1124` | `07-relational-write-path/03b-profile-aware-persist-executor.md` |
...
| Hard | `E07-S01a-C8` | `DMS-1112` | `07-relational-write-path/01a-c8-typed-profile-error-classification.md` | `E07-S05b` | `DMS-1104` | `07-relational-write-path/05b-profile-error-classification.md` |
| Hard | `E07-S01b` | `DMS-1106` | `07-relational-write-path/01b-profile-write-context.md` | `E07-S05b` | `DMS-1104` | `07-relational-write-path/05b-profile-error-classification.md` |
| Hard | `E07-S03b` | `DMS-1124` | `07-relational-write-path/03b-profile-aware-persist-executor.md` | `E07-S05b` | `DMS-1104` | `07-relational-write-path/05b-profile-error-classification.md` |
...
| Hard | `E07-S01a-C7` | `DMS-1113` | `07-relational-write-path/01a-c7-readable-profile-projection.md` | `E08-S01` | `DMS-990` | `08-relational-read-path/01-json-reconstitution.md` |
...
| Hard | `E07-S03` | `DMS-984` | `07-relational-write-path/03-persist-and-batch.md` | `E10-S03` | `DMS-1005` | `10-update-tracking-change-queries/03-if-match.md` |
...
| Hard | `E07-S03b` | `DMS-1124` | `07-relational-write-path/03b-profile-aware-persist-executor.md` | `E13-S01` | `DMS-1022` | `13-test-migration/01-backend-integration-tests.md` |
| Hard | `E07-S05b` | `DMS-1104` | `07-relational-write-path/05b-profile-error-classification.md` | `E13-S01` | `DMS-1022` | `13-test-migration/01-backend-integration-tests.md` |
...
| Hard | `E07-S01a` | `DMS-1110` | `07-relational-write-path/01a-core-profile-delivery-plan.md` | `E07-S01a-C8` | `DMS-1112` | `07-relational-write-path/01a-c8-typed-profile-error-classification.md` |
| Hard | `E07-S01a-C8` | `DMS-1112` | `07-relational-write-path/01a-c8-typed-profile-error-classification.md` | `E07-S01a-C2` | `DMS-1114` | `07-relational-write-path/01a-c2-semantic-identity-compatibility-validation.md` |
| Hard | `E07-S01a-C1` | `DMS-1111` | `07-relational-write-path/01a-c1-compiled-scope-adapter-and-address-derivation.md` | `E07-S01a-C2` | `DMS-1114` | `07-relational-write-path/01a-c2-semantic-identity-compatibility-validation.md` |
| Hard | `E07-S01a-C8` | `DMS-1112` | `07-relational-write-path/01a-c8-typed-profile-error-classification.md` | `E07-S01a-C3` | `DMS-1115` | `07-relational-write-path/01a-c3-request-visibility-and-writable-shaping.md` |
| Hard | `E07-S01a-C1` | `DMS-1111` | `07-relational-write-path/01a-c1-compiled-scope-adapter-and-address-derivation.md` | `E07-S01a-C3` | `DMS-1115` | `07-relational-write-path/01a-c3-request-visibility-and-writable-shaping.md` |
| Hard | `E07-S01a-C8` | `DMS-1112` | `07-relational-write-path/01a-c8-typed-profile-error-classification.md` | `E07-S01a-C4` | `DMS-1116` | `07-relational-write-path/01a-c4-request-creatability-and-collection-validation.md` |
| Hard | `E07-S01a-C1` | `DMS-1111` | `07-relational-write-path/01a-c1-compiled-scope-adapter-and-address-derivation.md` | `E07-S01a-C4` | `DMS-1116` | `07-relational-write-path/01a-c4-request-creatability-and-collection-validation.md` |
| Hard | `E07-S01a-C2` | `DMS-1114` | `07-relational-write-path/01a-c2-semantic-identity-compatibility-validation.md` | `E07-S01a-C4` | `DMS-1116` | `07-relational-write-path/01a-c4-request-creatability-and-collection-validation.md` |
| Hard | `E07-S01a-C3` | `DMS-1115` | `07-relational-write-path/01a-c3-request-visibility-and-writable-shaping.md` | `E07-S01a-C4` | `DMS-1116` | `07-relational-write-path/01a-c4-request-creatability-and-collection-validation.md` |
| Hard | `E07-S01a-C8` | `DMS-1112` | `07-relational-write-path/01a-c8-typed-profile-error-classification.md` | `E07-S01a-C5` | `DMS-1117` | `07-relational-write-path/01a-c5-assemble-profile-applied-write-request.md` |
| Hard | `E07-S01a-C1` | `DMS-1111` | `07-relational-write-path/01a-c1-compiled-scope-adapter-and-address-derivation.md` | `E07-S01a-C5` | `DMS-1117` | `07-relational-write-path/01a-c5-assemble-profile-applied-write-request.md` |
| Hard | `E07-S01a-C2` | `DMS-1114` | `07-relational-write-path/01a-c2-semantic-identity-compatibility-validation.md` | `E07-S01a-C5` | `DMS-1117` | `07-relational-write-path/01a-c5-assemble-profile-applied-write-request.md` |
| Hard | `E07-S01a-C3` | `DMS-1115` | `07-relational-write-path/01a-c3-request-visibility-and-writable-shaping.md` | `E07-S01a-C5` | `DMS-1117` | `07-relational-write-path/01a-c5-assemble-profile-applied-write-request.md` |
| Hard | `E07-S01a-C4` | `DMS-1116` | `07-relational-write-path/01a-c4-request-creatability-and-collection-validation.md` | `E07-S01a-C5` | `DMS-1117` | `07-relational-write-path/01a-c5-assemble-profile-applied-write-request.md` |
| Hard | `E07-S01a-C1` | `DMS-1111` | `07-relational-write-path/01a-c1-compiled-scope-adapter-and-address-derivation.md` | `E07-S01a-C6` | `DMS-1118` | `07-relational-write-path/01a-c6-stored-state-projection-and-hidden-member-paths.md` |
| Hard | `E07-S01a-C3` | `DMS-1115` | `07-relational-write-path/01a-c3-request-visibility-and-writable-shaping.md` | `E07-S01a-C6` | `DMS-1118` | `07-relational-write-path/01a-c6-stored-state-projection-and-hidden-member-paths.md` |
| Hard | `E07-S01a-C5` | `DMS-1117` | `07-relational-write-path/01a-c5-assemble-profile-applied-write-request.md` | `E07-S01a-C6` | `DMS-1118` | `07-relational-write-path/01a-c6-stored-state-projection-and-hidden-member-paths.md` |
