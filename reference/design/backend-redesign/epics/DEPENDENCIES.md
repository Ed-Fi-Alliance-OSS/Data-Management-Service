...
7. E08-S00 → E08-S01 → E08-S02 → E08-S03 → E08-S04
8. E09-S00 → E09-S01 → E09-S02 → E09-S03 → E09-S04
9. E10-S00 → E10-S01 → E10-S02 → E10-S03
10. E11-S00 → E11-S01 → E11-S02
11. E13-S01 → E13-S02 (runtime parity tests)
...
1. **Effective schema loader + OpenAPI stripping**
   - Source: E00-S00
   - Consumers: E00-S02/E00-S03, E01, E02-S03, E05-S03, E06 (runtime compile fallback)
...
4. **Naming + identifier shortening**
   ...
   - Consumers: E02, E05-S02 (plan compilation), E11-S01 fallback conflict mapping

5. **Dialect abstraction**
   - Source: E02-S00
   - Consumers: E02 DDL, E03 provisioning execution, E05-S02 plan compilation, E07/E08 runtime SQL execution utilities
