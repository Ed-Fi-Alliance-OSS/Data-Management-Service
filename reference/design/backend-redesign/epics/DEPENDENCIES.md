...
| E07-S01a-C5 | [`01a-c5-assemble-profile-applied-write-request.md`](07-relational-write-path/01a-c5-assemble-profile-applied-write-request.md) | E07-S01a-C3, E07-S01a-C4 | — | Orchestrate profile write pipeline + assemble `ProfileAppliedWriteRequest` (Core, Tier 2) |
