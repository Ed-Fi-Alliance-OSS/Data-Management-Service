...
| E07-S01a-C2 | [`01a-c2-semantic-identity-compatibility-validation.md`](07-relational-write-path/01a-c2-semantic-identity-compatibility-validation.md) | E07-S01a-C1 | — | Pre-runtime gate rejecting profiles hiding semantic-identity fields (Core, Tier 0) |
...
| E07-S01a-C4 | [`01a-c4-request-creatability-and-collection-validation.md`](07-relational-write-path/01a-c4-request-creatability-and-collection-validation.md) | E07-S01a-C1, E07-S01a-C2, E07-S01a-C3 | — | Request-side creatability + duplicate collection-item validation (Core, Tier 1) |
| E07-S01a-C5 | [`01a-c5-assemble-profile-applied-write-request.md`](07-relational-write-path/01a-c5-assemble-profile-applied-write-request.md) | E07-S01a-C3, E07-S01a-C4 | — | Assemble `ProfileAppliedWriteRequest` (Core, Tier 1) |
| E07-S01a-C6 | [`01a-c6-stored-state-projection-and-hidden-member-paths.md`](07-relational-write-path/01a-c6-stored-state-projection-and-hidden-member-paths.md) | E07-S01a-C1, E07-S01a-C3, E07-S01a-C5 | — | Stored-state projection + `HiddenMemberPaths` + `ProfileAppliedWriteContext` assembly (Core, Tier 2) |
