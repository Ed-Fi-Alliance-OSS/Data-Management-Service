...
- If either category is emitted, the physical schema change requires a `RelationalMappingVersion` bump; the bump and its locked-hash bless procedure are tracked by their own open ticket rather than owned by this story.
