...
- `reference/design/backend-redesign/ddl-generation.md` (seeding behavior)
- `reference/design/backend-redesign/mpack-format-v1.md` (seed-hash manifest format)
...
- `resource_key_seed_hash` matches the algorithm in `reference/design/backend-redesign/mpack-format-v1.md` (manifest string v1).
