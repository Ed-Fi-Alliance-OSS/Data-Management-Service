...
| C03 | `[DMS-1218] Return structured 403 for disabled client registration` | 2 | INV-01 (`IdentityModule:128` → `FailureResults.Authorization`) + full-contract assertion | C02 | RegisterEndpointTests | ready for review | recorded in C04 update (self-SHA rule) | INV-01 done; `When_allow_registration_is_disabled` asserts full 403 contract; V-05 green | — | — |
