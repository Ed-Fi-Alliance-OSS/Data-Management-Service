...
Status: **v3.2**. v3.1 was approved as the implementation plan (2026-09-23) and committed at step 0.1; v3.2 applies the step 0.2 review decisions (§0.00, A1–A7). Standalone; supersedes v1–v3.1. The §6.1 candidate defaults are retained by the step 0.2 operational assessment (`operational-assessment.md`), whose follow-up awaits review; Q3 stays open and Phase 1 does not start until it is approved.
...
- **Q3** Approve or adjust the candidate defaults at step 0.2 (initial assessment, before Phase 1); step 2.11 re-verifies against the implemented repositories. Step 0.2 retained every default and adjusted two bounds (§0.00); Q3 stays open until the step 0.2 follow-up is approved.
...
### 6.1 Candidate settings (`JobSettings`) — retained at step 0.2 (approval pending, Q3); re-verified at step 2.11
...
- **U-2 (AC 14).** Step 0.2 retained every candidate default and adjusted two bounds (§0.00); the decision stays unapproved until the step 0.2 follow-up is reviewed, Phase 1 does not start before then, and step 2.11 re-verifies it before Phase 3.
