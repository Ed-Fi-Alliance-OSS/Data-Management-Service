...
| Make snapshot-backed synchronization operationally implementable through an explicit instance-scoped published binding, request-time binding validation, and documented operator discipline for stable multi-request passes without implying unsupported cross-request pinning | `01-Feature-Summary-and-Decisions.md`, `02-API-Contract-and-Synchronization.md`, `03-Architecture-and-Execution.md`, `06-Validation-Rollout-and-Operations.md` | `CQ-STORY-00`, `CQ-STORY-05`, `CQ-STORY-07`, `CQ-STORY-08` |
...
| Reliable key-change detection with one public row per affected resource item carrying the window's initial and final key values | `02-API-Contract-and-Synchronization.md`, `03-Architecture-and-Execution.md`, `04-Data-Model-and-DDL.md`, `05-Authorization-and-Delete-Semantics.md`, `06-Validation-Rollout-and-Operations.md` | `CQ-STORY-04`, `CQ-STORY-07`, `CQ-STORY-08` |
...
- `keyChanges` is treated as a peer Change Queries endpoint to `/deletes`, not deferred scope, and preserves the ODS-style one-row-per-affected-resource-item semantics with initial and final key values for the requested window
