You are implementing the plan at 409-fix-plan.md,
It is part of a of a design found in reference/design/backend-redesign/design-docs/summary.md
...
Read progress.txt in the repo root folder to see what you have done so far, then take these actions:
...
- For the selected task, use its description, acceptance-criteria, and steps-to-verify fields as the implementation contract.
