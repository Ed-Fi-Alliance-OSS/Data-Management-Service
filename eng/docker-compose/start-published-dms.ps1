...
param (
    ...
    # since CMS must actually run to create the separate database. MSSQL only in this phase
    # (DMS-1270 Phase 1b) - PostgreSQL support lands in Phase 2; combining this with
    # -DatabaseEngine postgresql fails fast.
    [Switch]
