    ...
    public class Given_A_Repository_That_Returns_Failure_References : UpsertHandlerTests
    {
        ...
        public void It_has_the_correct_response()
        {
            ...
            context.FrontendResponse.Body.Should().Be(
                """
                {"detail":"The referenced BadResourceName1,BadResourceName2 resource(s) do not exist.","type":"urn:ed-fi:api:data-conflict:unresolved-reference","title":"Unresolved Reference","status":409,"correlationId":null,"validationErrors":null,"errors":null}
                """
            );
