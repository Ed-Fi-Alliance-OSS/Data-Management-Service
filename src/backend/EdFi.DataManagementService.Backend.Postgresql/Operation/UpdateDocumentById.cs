...
{
    public Task<UpdateResult> UpdateById(IUpdateRequest updateRequest, NpgsqlDataSource dataSource);
}

public class UpdateDocumentById(ILogger<UpdateDocumentById> _logger) : IUpdateDocumentById
{
    public async Task<UpdateResult> UpdateById(IUpdateRequest updateRequest, NpgsqlDataSource dataSource)
    {
