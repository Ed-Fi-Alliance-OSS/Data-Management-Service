...
[TestFixture]
public class QueryTest : DatabaseTest
{
    [TestFixture]
    public class Given_an_upsert_of_a_new_document : QueryTest
    {
    ...
    [TestFixture]
    public class Given_multiple_upserts_of_a_document_whit_same_resource_name : QueryTest
    {
        private UpsertResult? _upsertResult;
    ...
    [TestFixture]
    public class Given_multiple_upserts_of_a_document_whit_diferent_resource_name : QueryTest
    {
        private UpsertResult? _upsertResult;
        private QueryResult? _getByKeyResults;
