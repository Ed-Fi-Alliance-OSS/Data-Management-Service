...
echo "Running EdFi.DataManagementService.Frontend.SchoolYearLoader Cli START_YEAR=${START_YEAR}  END_YEAR=${END_YEAR}"
dotnet /app/SchoolYearLoader/EdFi.DataManagementService.Frontend.SchoolYearLoader.dll --startYear ${START_YEAR} --endYear ${END_YEAR}
