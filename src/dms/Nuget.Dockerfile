...
ENV CORE_PACKAGE_VERSION=1.0.149
ENV TPDM_PACKAGE=EdFi.DataStandard52.ApiSchema.TPDM
ENV TPDM_PACKAGE_VERSION=1.0.149
ENV Sample_PACKAGE=EdFi.DataStandard52.ApiSchema.Sample
ENV Sample_PACKAGE_VERSION=1.0.149
ENV Homograph_PACKAGE=EdFi.DataStandard52.ApiSchema.Homograph
ENV Homograph_PACKAGE_VERSION=1.0.149
WORKDIR /app
