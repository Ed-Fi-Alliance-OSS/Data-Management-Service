...
public class Given_E2E_Feature_File_Guardrails
{
    ...
    [Test]
    public void It_assigns_exactly_one_e2e_ci_shard_tag_to_every_dms_scenario()
    {
        ...
        offendingScenarios
            .Should()
            .BeEmpty(
                "each DMS E2E scenario must carry exactly one @e2e-ci-shard-N tag so PR CI shards balance and never overlap"
            );
    }
