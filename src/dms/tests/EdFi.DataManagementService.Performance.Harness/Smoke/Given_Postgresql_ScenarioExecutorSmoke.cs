...
public class Given_Postgresql_ScenarioExecutorSmoke : PostgresqlApiIntegrationTestBase
{
    ...
    {
        await ScenarioExecutorSmoke.RunAsync(Harness, PerfProvider.Postgresql);
    }
}
