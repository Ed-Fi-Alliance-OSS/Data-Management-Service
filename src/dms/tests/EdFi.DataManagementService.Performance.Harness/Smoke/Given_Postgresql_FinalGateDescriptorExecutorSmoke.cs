...
public class Given_Postgresql_FinalGateDescriptorExecutorSmoke : PostgresqlApiIntegrationTestBase
{
    ...
    {
        await PerfFinalGateExecutorSmokeScenario.RunDescriptorAsync(Harness, PerfProvider.Postgresql);
    }
}
