...
public class Given_Mssql_FinalGateAuthorizedExecutorSmoke : MssqlApiIntegrationTestBase
{
    ...
    {
        await PerfFinalGateExecutorSmokeScenario.RunAuthorizedAsync(Harness, PerfProvider.Mssql);
    }
}
