...
public static class PerfResultsCsvWriter
{
    ...
    private static IReadOnlyList<string> FieldsFor(PerfScenarioResult result) =>
        [
            ...
            Milliseconds(result.DbCommandMs.P50Ms),
            Milliseconds(result.DbCommandMs.P95Ms),
            Milliseconds(result.DbCommandMs.MeanMs),
            Milliseconds(result.DbCommandMs.MinMs),
            Milliseconds(result.DbCommandMs.MaxMs),
