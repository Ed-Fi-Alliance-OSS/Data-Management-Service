...
/// <summary>
/// The PostgreSQL primary final-gate evidence run, configured entirely through PERF_*
...
public class Given_Postgresql_FinalGatePrimaryRun : PostgresqlApiIntegrationTestBase
{
