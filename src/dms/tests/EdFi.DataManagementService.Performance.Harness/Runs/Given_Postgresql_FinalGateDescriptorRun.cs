...
/// <summary>
/// The PostgreSQL descriptor final-gate evidence run, configured entirely through PERF_*
...
public class Given_Postgresql_FinalGateDescriptorRun : PostgresqlApiIntegrationTestBase
{
