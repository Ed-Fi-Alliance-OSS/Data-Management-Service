...
/// <summary>
/// The PostgreSQL evidence-run entry point, configured entirely through PERF_* environment
...
public class Given_Postgresql_TraditionalBaselineRun : PostgresqlApiIntegrationTestBase
{
