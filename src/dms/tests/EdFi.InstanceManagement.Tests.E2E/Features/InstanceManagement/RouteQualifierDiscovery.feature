    ...
    Scenario: Discovery endpoint with tenant and full route qualifiers returns URLs with route context
         ...
         Then it should respond with 200
          ...
          And the urls should be
              """
                {
                    "dependencies": "http://localhost:8080/Tenant_255901/255901/2024/metadata/dependencies",
                    "openApiMetadata": "http://localhost:8080/Tenant_255901/255901/2024/metadata/specifications",
                    "oauth": "http://localhost:8080/Tenant_255901/255901/2024/oauth/token",
    ...
    Scenario: Discovery endpoint with tenant and partial route qualifier returns URLs with mixed context
         ...
         Then it should respond with 200
          And the urls should be
              """
                {
                    "dependencies": "http://localhost:8080/Tenant_255901/255901/{schoolYear}/metadata/dependencies",
                    "openApiMetadata": "http://localhost:8080/Tenant_255901/255901/{schoolYear}/metadata/specifications",
                    "oauth": "http://localhost:8080/Tenant_255901/255901/{schoolYear}/oauth/token",
    ...
    Scenario: Discovery endpoint with tenant only returns URLs with route qualifier placeholders
         ...
         Then it should respond with 200
          And the urls should be
              """
                {
                    "dependencies": "http://localhost:8080/Tenant_255901/{districtId}/{schoolYear}/metadata/dependencies",
                    "openApiMetadata": "http://localhost:8080/Tenant_255901/{districtId}/{schoolYear}/metadata/specifications",
