...
/// <summary>
/// SQL Server twin of the windowed cursor walk. The bounds, the keyset, and the anchor carried out of
/// selection come from real SQL Server query execution, so a walk that terminates correctly on one
/// engine says nothing about the other.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class Given_Mssql_WindowedCursorAnchoring : MssqlApiIntegrationTestBase
{
...
public sealed class Given_Mssql_WindowedCursorAnchoring_NamespaceAuthorization : MssqlApiIntegrationTestBase
{
