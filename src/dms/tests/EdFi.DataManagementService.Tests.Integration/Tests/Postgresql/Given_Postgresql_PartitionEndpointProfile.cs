...
/// <summary>
/// PostgreSQL profile behavior for the partitions endpoint, bound to the profile fixture because that is
/// where the profile XML lives. Profile resolution happens in Core ahead of any provider work, but the
/// success case reaches real query execution, so both engines run it.
/// </summary>
public sealed class Given_Postgresql_PartitionEndpointProfile : PostgresqlApiIntegrationTestBase
{
