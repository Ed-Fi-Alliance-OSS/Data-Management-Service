...
public sealed class Given_Postgresql_PeopleRelationshipGetManyContact : PostgresqlApiIntegrationTestBase
{
...
public sealed class Given_Postgresql_PeopleRelationshipGetManyStaff : PostgresqlApiIntegrationTestBase
{
    protected override FixtureKey Fixture => FixtureKey.AuthorizationQuery;
