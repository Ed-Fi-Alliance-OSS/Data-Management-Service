...
/// <summary>
/// PostgreSQL proof of what a walk observes when the collection changes underneath it: a later insert
...
/// </remarks>
public sealed class Given_Postgresql_CursorPartitionConcurrency : PostgresqlApiIntegrationTestBase
{
