...
public sealed class Given_Postgresql_WriteCreateGuardIfNoneMatch : PostgresqlApiIntegrationTestBase
{
...
/// </summary>
public sealed class Given_Postgresql_WriteCreateGuardIfNoneMatch_DeferredAuthorizationPath
