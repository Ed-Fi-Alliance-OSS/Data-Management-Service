...
export default function () {
    ...
    // Create descriptor
    const createResult = localApiClient.post('/data/v3/ed-fi/gradeLevelDescriptors', descriptorData, 'gradeLevelDescriptors');
    ...
    if (createResult.success) {
        ...
        const readResult = localApiClient.get(`/data/v3/ed-fi/gradeLevelDescriptors/${id}`);
        ...
        // Update descriptor
        const updatedData = { ...descriptorData, shortDescription: 'Updated Test Descriptor' };
        const updateResult = localApiClient.put(`/data/v3/ed-fi/gradeLevelDescriptors/${id}`, updatedData);
        ...
        // Delete descriptor
        const deleteResult = localApiClient.delete(`/data/v3/ed-fi/gradeLevelDescriptors/${id}`);
    ...
    const listResult = localApiClient.get('/data/v3/ed-fi/academicWeeks?limit=5');
    ...
    const batchRequests = [
        ...
        { method: 'GET', endpoint: '/data/v3/ed-fi/academicWeeks?limit=1', tags: { name: 'batch_list' } }
    ];
