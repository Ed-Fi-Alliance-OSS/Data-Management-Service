        ...
        Scenario: 17 Post a Descriptor using a resource not configured in claims
            ...
            Then it should respond with 403
              And the response body is
                  ...
                  """
        Scenario: 18 Ensure clients can create objectiveAssessments
             When a POST request is made to "/ed-fi/assessmentReportingMethodDescriptors" with
                  """
                    {
             ...
             Then it should respond with 201
              And the response headers include
                  """
                    {
                        "location": "/ed-fi/assessmentReportingMethodDescriptors/{id}"
                    }
                  """
              And the record can be retrieved with a GET request
                  """
                  ...
                  """
             When a POST request is made to "/ed-fi/performanceLevelDescriptors" with
                  """
                    {
             ...
             Then it should respond with 201
              And the response headers include
                  """
                    {
                        "location": "/ed-fi/performanceLevelDescriptors/{id}"
                    }
                  """
              And the record can be retrieved with a GET request
                  """
                  ...
                  """
             When a POST request is made to "/ed-fi/AssessmentCategoryDescriptors" with
                  """
                    {
             ...
             Then it should respond with 201
              And the response headers include
                  """
                    {
                        "location": "/ed-fi/AssessmentCategoryDescriptors/{id}"
                    }
                  """
              And the record can be retrieved with a GET request
                  """
             ...
             Then it should respond with 201
              And the response headers include
                  """
                    {
                        "location": "/ed-fi/AcademicSubjectDescriptors/{id}"
                    }
                  """
              And the record can be retrieved with a GET request
                  """
