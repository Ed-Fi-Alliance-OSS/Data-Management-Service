Feature: RelationshipsWithEdOrgsAndPeople Authorization
    ...
    Rule: Edge cases are properly authorized
        ...
        Scenario: 46 Ensure client can query a Student associated to a School with a long ID
    ...
    Rule: Multiple relationships are properly authorized
        ...
        Scenario: 47 Ensure client with access to both schools can query multiple student school associations
             ...
             Then it should respond with 200
              And the response body is
                  ...
                  """
        Scenario: 48 Ensure client with access to one school can query one student school associations
            Given the claimSet "EdFiSandbox" is authorized with educationOrganizationIds "11"
             ...
             Then it should respond with 200
              And the response body is
                  ...
                  """
        Scenario: 49 Ensure search still works when the student association is updated and deleted
