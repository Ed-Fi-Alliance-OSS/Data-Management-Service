        ...
        Scenario: 48 Ensure client with access to both schools can query multiple student school associations
             ...
             Then it should respond with 200
              And the response body is
                  ...
                  """
        Scenario: 49 Ensure client with access to one school can query one student school associations
            Given the claimSet "EdFiSandbox" is authorized with educationOrganizationIds "1155901"
             ...
             Then it should respond with 200
              And the response body is
                  ...
                  """
        Scenario: 50 Ensure search still works when the student association is updated and deleted
            Given the claimSet "EdFiSandbox" is authorized with educationOrganizationIds "11559010011111,11559020011111,5"
