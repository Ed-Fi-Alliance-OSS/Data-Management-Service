...
CREATE INDEX IF NOT EXISTS IX_StudentContactRelation_StudentContactAssociationDocumentId_StudentContactAssociationDocumentPartitionKey ON dms.StudentContactRelation (StudentContactAssociationDocumentId, StudentContactAssociationDocumentPartitionKey);
