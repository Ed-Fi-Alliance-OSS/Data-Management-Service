...
CREATE INDEX IF NOT EXISTS IX_ContactSecurableDocument_ContactSecurableDocumentId_ContactSecurableDocumentPartitionKey ON dms.ContactSecurableDocument (ContactSecurableDocumentId, ContactSecurableDocumentPartitionKey);
