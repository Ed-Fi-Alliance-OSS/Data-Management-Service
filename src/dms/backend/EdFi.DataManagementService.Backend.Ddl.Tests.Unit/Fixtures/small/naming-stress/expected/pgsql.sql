...
BEGIN
    IF to_regclass('"dms"."EffectiveSchema"') IS NOT NULL THEN
        ...
        IF _stored_hash IS NOT NULL AND _stored_hash <> '11fb8848a557c7df7a153c01159915b4778d67dee312d617fb0d3b1d2b7ee83c' THEN
            RAISE EXCEPTION 'EffectiveSchemaHash mismatch: database has ''%'' but expected ''%''', _stored_hash, '11fb8848a557c7df7a153c01159915b4778d67dee312d617fb0d3b1d2b7ee83c';
        END IF;
    END IF;
END $$;
...
BEGIN
    IF to_regclass('"dms"."EffectiveSchema"') IS NOT NULL THEN
        SELECT "EffectiveSchemaHash" INTO _stored_hash FROM "dms"."EffectiveSchema"
        WHERE "EffectiveSchemaSingletonId" = 1;
        IF _stored_hash = '11fb8848a557c7df7a153c01159915b4778d67dee312d617fb0d3b1d2b7ee83c' THEN
...
VALUES (1, '1.0.0', '11fb8848a557c7df7a153c01159915b4778d67dee312d617fb0d3b1d2b7ee83c', 1, '\xECD1439457B6F0560A20DF2668B314E42DCF6079592558C4695F2B299DFBC301'::bytea)
...
VALUES ('11fb8848a557c7df7a153c01159915b4778d67dee312d617fb0d3b1d2b7ee83c', 'ed-fi', 'Ed-Fi', '5.0.0', false)
...
BEGIN
    SELECT COUNT(*) INTO _actual_count FROM "dms"."SchemaComponent" WHERE "EffectiveSchemaHash" = '11fb8848a557c7df7a153c01159915b4778d67dee312d617fb0d3b1d2b7ee83c';
    IF _actual_count <> 1 THEN
    ...
    WHERE sc."EffectiveSchemaHash" = '11fb8848a557c7df7a153c01159915b4778d67dee312d617fb0d3b1d2b7ee83c'
    AND NOT EXISTS (
        SELECT 1 FROM (VALUES
