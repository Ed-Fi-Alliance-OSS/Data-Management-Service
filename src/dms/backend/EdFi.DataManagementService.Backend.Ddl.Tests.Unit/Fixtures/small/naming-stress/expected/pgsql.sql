...
BEGIN
    IF to_regclass('"dms"."EffectiveSchema"') IS NOT NULL THEN
        ...
        IF _stored_hash IS NOT NULL AND _stored_hash <> '58c74e3ea486c17d14eef5dd678f7e6e520ebf96bef95a26c8ae994c60d8f389' THEN
            RAISE EXCEPTION 'EffectiveSchemaHash mismatch: database has ''%'' but expected ''%''', _stored_hash, '58c74e3ea486c17d14eef5dd678f7e6e520ebf96bef95a26c8ae994c60d8f389';
        END IF;
    END IF;
END $$;
...
VALUES (1, '1.0.0', '58c74e3ea486c17d14eef5dd678f7e6e520ebf96bef95a26c8ae994c60d8f389', 1, '\xECD1439457B6F0560A20DF2668B314E42DCF6079592558C4695F2B299DFBC301'::bytea)
...
VALUES ('58c74e3ea486c17d14eef5dd678f7e6e520ebf96bef95a26c8ae994c60d8f389', 'ed-fi', 'Ed-Fi', '5.0.0', false)
...
BEGIN
    SELECT COUNT(*) INTO _actual_count FROM "dms"."SchemaComponent" WHERE "EffectiveSchemaHash" = '58c74e3ea486c17d14eef5dd678f7e6e520ebf96bef95a26c8ae994c60d8f389';
    IF _actual_count <> 1 THEN
    ...
    WHERE sc."EffectiveSchemaHash" = '58c74e3ea486c17d14eef5dd678f7e6e520ebf96bef95a26c8ae994c60d8f389'
    AND NOT EXISTS (
        SELECT 1 FROM (VALUES
