...
BEGIN
    ...
    IF @preflight_stored_hash IS NOT NULL AND @preflight_stored_hash <> N'58c74e3ea486c17d14eef5dd678f7e6e520ebf96bef95a26c8ae994c60d8f389'
    BEGIN
        DECLARE @preflight_msg nvarchar(500) = CONCAT(N'EffectiveSchemaHash mismatch: database has ''', @preflight_stored_hash, N''' but expected ''', N'58c74e3ea486c17d14eef5dd678f7e6e520ebf96bef95a26c8ae994c60d8f389', N'''');
...
(
    ...
    [ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThree] nvarchar(100) NULL,
...
IF NOT EXISTS (
    SELECT 1 FROM sys.foreign_keys
    WHERE name = N'FK_NamingStressItem_Document' AND parent_object_id = OBJECT_ID(N'edfi.NamingStressItem')
)
ALTER TABLE [edfi].[NamingStressItem]
...
BEGIN
    ...
    ;WITH affectedDocs AS (
        ...
        WHERE del.[DocumentId] IS NULL OR (i.[DocumentId] <> del.[DocumentId] OR (i.[DocumentId] IS NULL AND del.[DocumentId] IS NOT NULL) OR (i.[DocumentId] IS NOT NULL AND del.[DocumentId] IS NULL)) OR (i.[NamingStressItemId] <> del.[NamingStressItemId] OR (i.[NamingStressItemId] IS NULL AND del.[NamingStressItemId] IS NOT NULL) OR (i.[NamingStressItemId] IS NOT NULL AND del.[NamingStressItemId] IS NULL)) OR (i.[Order] <> del.[Order] OR (i.[Order] IS NULL AND del.[Order] IS NOT NULL) OR (i.[Order] IS NOT NULL AND del.[Order] IS NULL)) OR (i.[ShortName] <> del.[ShortName] OR (i.[ShortName] IS NULL AND del.[ShortName] IS NOT NULL) OR (i.[ShortName] IS NOT NULL AND del.[ShortName] IS NULL)) OR (i.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThree] <> del.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThree] OR (i.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThree] IS NULL AND del.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThree] IS NOT NULL) OR (i.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThree] IS NOT NULL AND del.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThree] IS NULL)) OR (i.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThreeX] <> del.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThreeX] OR (i.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThreeX] IS NULL AND del.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThreeX] IS NOT NULL) OR (i.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThreeX] IS NOT NULL AND del.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThreeX] IS NULL)) OR (i.[VeryLongIdentifierNameThatExceedsSixtyThreeCharactersInPostgreSQL] <> del.[VeryLongIdentifierNameThatExceedsSixtyThreeCharactersInPostgreSQL] OR (i.[VeryLongIdentifierNameThatExceedsSixtyThreeCharactersInPostgreSQL] IS NULL AND del.[VeryLongIdentifierNameThatExceedsSixtyThreeCharactersInPostgreSQL] IS NOT NULL) OR (i.[VeryLongIdentifierNameThatExceedsSixtyThreeCharactersInPostgreSQL] IS NOT NULL AND del.[VeryLongIdentifierNameThatExceedsSixtyThreeCharactersInPostgreSQL] IS NULL))
        UNION
        SELECT del.[DocumentId]
        FROM deleted del
        LEFT JOIN inserted i ON i.[DocumentId] = del.[DocumentId]
        WHERE i.[DocumentId] IS NULL OR (i.[DocumentId] <> del.[DocumentId] OR (i.[DocumentId] IS NULL AND del.[DocumentId] IS NOT NULL) OR (i.[DocumentId] IS NOT NULL AND del.[DocumentId] IS NULL)) OR (i.[NamingStressItemId] <> del.[NamingStressItemId] OR (i.[NamingStressItemId] IS NULL AND del.[NamingStressItemId] IS NOT NULL) OR (i.[NamingStressItemId] IS NOT NULL AND del.[NamingStressItemId] IS NULL)) OR (i.[Order] <> del.[Order] OR (i.[Order] IS NULL AND del.[Order] IS NOT NULL) OR (i.[Order] IS NOT NULL AND del.[Order] IS NULL)) OR (i.[ShortName] <> del.[ShortName] OR (i.[ShortName] IS NULL AND del.[ShortName] IS NOT NULL) OR (i.[ShortName] IS NOT NULL AND del.[ShortName] IS NULL)) OR (i.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThree] <> del.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThree] OR (i.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThree] IS NULL AND del.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThree] IS NOT NULL) OR (i.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThree] IS NOT NULL AND del.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThree] IS NULL)) OR (i.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThreeX] <> del.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThreeX] OR (i.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThreeX] IS NULL AND del.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThreeX] IS NOT NULL) OR (i.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThreeX] IS NOT NULL AND del.[ThisIsAVeryLongFieldNameThatWillBeTruncatedByPostgreSQLAtSixtyThreeX] IS NULL)) OR (i.[VeryLongIdentifierNameThatExceedsSixtyThreeCharactersInPostgreSQL] <> del.[VeryLongIdentifierNameThatExceedsSixtyThreeCharactersInPostgreSQL] OR (i.[VeryLongIdentifierNameThatExceedsSixtyThreeCharactersInPostgreSQL] IS NULL AND del.[VeryLongIdentifierNameThatExceedsSixtyThreeCharactersInPostgreSQL] IS NOT NULL) OR (i.[VeryLongIdentifierNameThatExceedsSixtyThreeCharactersInPostgreSQL] IS NOT NULL AND del.[VeryLongIdentifierNameThatExceedsSixtyThreeCharactersInPostgreSQL] IS NULL))
    )
    UPDATE d
...
IF NOT EXISTS (SELECT 1 FROM [dms].[ResourceKey] WHERE [ResourceKeyId] = 1)
    ...
    VALUES (1, N'Ed-Fi', N'NamingStressItem', N'5.0.0');
...
WHERE NOT EXISTS (
    SELECT 1 FROM (VALUES
        (1, N'Ed-Fi', N'NamingStressItem', N'5.0.0')
...
IF NOT EXISTS (SELECT 1 FROM [dms].[EffectiveSchema] WHERE [EffectiveSchemaSingletonId] = 1)
    ...
    VALUES (1, N'1.0.0', N'58c74e3ea486c17d14eef5dd678f7e6e520ebf96bef95a26c8ae994c60d8f389', 1, 0xECD1439457B6F0560A20DF2668B314E42DCF6079592558C4695F2B299DFBC301);
...
BEGIN
    ...
    END
    IF @es_stored_hash <> 0xECD1439457B6F0560A20DF2668B314E42DCF6079592558C4695F2B299DFBC301
    BEGIN
        DECLARE @es_hash_msg nvarchar(200) = CONCAT(N'dms.EffectiveSchema ResourceKeySeedHash mismatch: stored ', CONVERT(nvarchar(66), @es_stored_hash, 1), N' but expected ', CONVERT(nvarchar(66), 0xECD1439457B6F0560A20DF2668B314E42DCF6079592558C4695F2B299DFBC301, 1));
        THROW 50000, @es_hash_msg, 1;
    END
END

-- SchemaComponent seed inserts (insert-if-missing)
IF NOT EXISTS (SELECT 1 FROM [dms].[SchemaComponent] WHERE [EffectiveSchemaHash] = N'58c74e3ea486c17d14eef5dd678f7e6e520ebf96bef95a26c8ae994c60d8f389' AND [ProjectEndpointName] = N'ed-fi')
    INSERT INTO [dms].[SchemaComponent] ([EffectiveSchemaHash], [ProjectEndpointName], [ProjectName], [ProjectVersion], [IsExtensionProject])
    VALUES (N'58c74e3ea486c17d14eef5dd678f7e6e520ebf96bef95a26c8ae994c60d8f389', N'ed-fi', N'Ed-Fi', N'5.0.0', 0);
...
SELECT @sc_actual_count = COUNT(*) FROM [dms].[SchemaComponent] WHERE [EffectiveSchemaHash] = N'58c74e3ea486c17d14eef5dd678f7e6e520ebf96bef95a26c8ae994c60d8f389';
...
WHERE sc.[EffectiveSchemaHash] = N'58c74e3ea486c17d14eef5dd678f7e6e520ebf96bef95a26c8ae994c60d8f389'
AND NOT EXISTS (
    SELECT 1 FROM (VALUES
