...
BEGIN
    WITH affected AS (
        ...
        FROM newtab n
        LEFT JOIN oldtab o ON o."CollectionItemId" = n."CollectionItemId"
        WHERE o."CollectionItemId" IS NULL OR n."CollectionItemId" IS DISTINCT FROM o."CollectionItemId" OR n."Ordinal" IS DISTINCT FROM o."Ordinal" OR n."ParentCollectionItemId" IS DISTINCT FROM o."ParentCollectionItemId" OR n."School_DocumentId" IS DISTINCT FROM o."School_DocumentId" OR n."PhoneNumber" IS DISTINCT FROM o."PhoneNumber"
        UNION
        SELECT o."School_DocumentId" AS "DocumentId"
        FROM oldtab o
        LEFT JOIN newtab n ON n."CollectionItemId" = o."CollectionItemId"
        WHERE n."CollectionItemId" IS NULL OR n."CollectionItemId" IS DISTINCT FROM o."CollectionItemId" OR n."Ordinal" IS DISTINCT FROM o."Ordinal" OR n."ParentCollectionItemId" IS DISTINCT FROM o."ParentCollectionItemId" OR n."School_DocumentId" IS DISTINCT FROM o."School_DocumentId" OR n."PhoneNumber" IS DISTINCT FROM o."PhoneNumber"
    ),
    stamped AS (
        UPDATE "dms"."Document" d
        SET "ContentVersion" = nextval('"dms"."ChangeVersionSequence"'), "ContentLastModifiedAt" = now()
