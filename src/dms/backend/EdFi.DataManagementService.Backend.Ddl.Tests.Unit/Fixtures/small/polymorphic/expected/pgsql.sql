...
BEGIN
    IF to_regclass('"dms"."EffectiveSchema"') IS NOT NULL THEN
        ...
        IF _stored_hash IS NOT NULL AND _stored_hash <> '6424eb94359a90ac7f3c8ef529cf48ef799e28281a2fbecd5e6835969a971351' THEN
            RAISE EXCEPTION 'EffectiveSchemaHash mismatch: database has ''%'' but expected ''%''', _stored_hash, '6424eb94359a90ac7f3c8ef529cf48ef799e28281a2fbecd5e6835969a971351';
        END IF;
    END IF;
END $$;
...
BEGIN
    IF to_regclass('"dms"."EffectiveSchema"') IS NOT NULL THEN
        SELECT "EffectiveSchemaHash" INTO _stored_hash FROM "dms"."EffectiveSchema"
        WHERE "EffectiveSchemaSingletonId" = 1;
        IF _stored_hash = '6424eb94359a90ac7f3c8ef529cf48ef799e28281a2fbecd5e6835969a971351' THEN
...
VALUES (1, '1.0.0', '6424eb94359a90ac7f3c8ef529cf48ef799e28281a2fbecd5e6835969a971351', 3, '\x13390DEE0A99E1FF56E7F39CB8F5B43BEDA834078EA87A4975FE84B5710F6252'::bytea)
...
VALUES ('6424eb94359a90ac7f3c8ef529cf48ef799e28281a2fbecd5e6835969a971351', 'ed-fi', 'Ed-Fi', '5.0.0', false)
...
BEGIN
    SELECT COUNT(*) INTO _actual_count FROM "dms"."SchemaComponent" WHERE "EffectiveSchemaHash" = '6424eb94359a90ac7f3c8ef529cf48ef799e28281a2fbecd5e6835969a971351';
    ...
    WHERE sc."EffectiveSchemaHash" = '6424eb94359a90ac7f3c8ef529cf48ef799e28281a2fbecd5e6835969a971351'
    AND NOT EXISTS (
        SELECT 1 FROM (VALUES
