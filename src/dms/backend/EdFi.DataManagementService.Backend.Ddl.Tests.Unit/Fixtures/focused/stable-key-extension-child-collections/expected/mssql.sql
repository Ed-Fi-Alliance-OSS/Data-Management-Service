...
BEGIN
    ...
    BEGIN
        ...
        WHERE (i.[ProgramName] <> d.[ProgramName] OR (i.[ProgramName] IS NULL AND d.[ProgramName] IS NOT NULL) OR (i.[ProgramName] IS NOT NULL AND d.[ProgramName] IS NULL));
        DELETE FROM [dms].[ReferentialIdentity]
...
BEGIN
    ...
    BEGIN
        ...
        WHERE (i.[ProgramName] <> del.[ProgramName] OR (i.[ProgramName] IS NULL AND del.[ProgramName] IS NOT NULL) OR (i.[ProgramName] IS NOT NULL AND del.[ProgramName] IS NULL));
    END
END;
GO
