...
/// These are artifact-level contract checks over emitted paths only. They make no claim about
/// how the upstream generator reaches that result: it decides collection scope from semantic
/// metadata, and extension-scoped resources never carry these securable elements at all.
/// </summary>
