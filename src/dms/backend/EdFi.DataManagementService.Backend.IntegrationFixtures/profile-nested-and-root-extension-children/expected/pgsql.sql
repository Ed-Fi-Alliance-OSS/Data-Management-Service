...
BEGIN
    IF to_regclass('"dms"."EffectiveSchema"') IS NOT NULL THEN
        ...
        IF _stored_hash IS NOT NULL AND _stored_hash <> 'd5ef03614de79ee4fb420fa29855da446a652984587c3ffe656267cd6bcc8a59' THEN
            RAISE EXCEPTION 'EffectiveSchemaHash mismatch: database has ''%'' but expected ''%''', _stored_hash, 'd5ef03614de79ee4fb420fa29855da446a652984587c3ffe656267cd6bcc8a59';
        END IF;
    END IF;
END $$;
...
VALUES (1, '1.0.0', 'd5ef03614de79ee4fb420fa29855da446a652984587c3ffe656267cd6bcc8a59', 1, '\xAA4516A2188A393B97F346BD6483E8A82E57AB430F5377D00B6409E307A812DC'::bytea)
...
VALUES ('d5ef03614de79ee4fb420fa29855da446a652984587c3ffe656267cd6bcc8a59', 'ed-fi', 'Ed-Fi', '1.0.0', false)
ON CONFLICT ("EffectiveSchemaHash", "ProjectEndpointName") DO NOTHING;
INSERT INTO "dms"."SchemaComponent" ("EffectiveSchemaHash", "ProjectEndpointName", "ProjectName", "ProjectVersion", "IsExtensionProject")
VALUES ('d5ef03614de79ee4fb420fa29855da446a652984587c3ffe656267cd6bcc8a59', 'root_ext', 'RootExt', '1.0.0', true)
ON CONFLICT ("EffectiveSchemaHash", "ProjectEndpointName") DO NOTHING;
...
BEGIN
    SELECT COUNT(*) INTO _actual_count FROM "dms"."SchemaComponent" WHERE "EffectiveSchemaHash" = 'd5ef03614de79ee4fb420fa29855da446a652984587c3ffe656267cd6bcc8a59';
    ...
    WHERE sc."EffectiveSchemaHash" = 'd5ef03614de79ee4fb420fa29855da446a652984587c3ffe656267cd6bcc8a59'
    AND NOT EXISTS (
        SELECT 1 FROM (VALUES
