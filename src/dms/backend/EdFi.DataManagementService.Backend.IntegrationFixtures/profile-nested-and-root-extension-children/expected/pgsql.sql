...
BEGIN
    IF to_regclass('"dms"."EffectiveSchema"') IS NOT NULL THEN
        ...
        IF _stored_hash IS NOT NULL AND _stored_hash <> '3440540b5709531eda900de5f0ff11466c14e92c5c7d114d30cff155d27cdac3' THEN
            RAISE EXCEPTION 'EffectiveSchemaHash mismatch: database has ''%'' but expected ''%''', _stored_hash, '3440540b5709531eda900de5f0ff11466c14e92c5c7d114d30cff155d27cdac3';
        END IF;
    END IF;
END $$;
...
BEGIN
    IF to_regclass('"dms"."EffectiveSchema"') IS NOT NULL THEN
        SELECT "EffectiveSchemaHash" INTO _stored_hash FROM "dms"."EffectiveSchema"
        WHERE "EffectiveSchemaSingletonId" = 1;
        IF _stored_hash = '3440540b5709531eda900de5f0ff11466c14e92c5c7d114d30cff155d27cdac3' THEN
...
CREATE SCHEMA IF NOT EXISTS "rootext";
...
CREATE TABLE IF NOT EXISTS "rootext"."ParentResourceExtension"
(
    "DocumentId" bigint NOT NULL,
    "RootExtHiddenScalar" varchar(100) NULL,
    "RootExtVisibleScalar" varchar(100) NULL,
    CONSTRAINT "PK_ParentResourceExtension" PRIMARY KEY ("DocumentId")
);

CREATE TABLE IF NOT EXISTS "rootext"."ParentResourceExtensionRootExtChildren"
(
    ...
    "RootExtChildCode" varchar(30) NULL,
    "RootExtChildValue" varchar(100) NULL,
    CONSTRAINT "PK_ParentResourceExtensionRootExtChildren" PRIMARY KEY ("CollectionItemId"),
    CONSTRAINT "UX_ParentResourceExtensionRootExtChildren_Ordinal_Pa_6fd180b534" UNIQUE ("ParentResource_DocumentId", "Ordinal"),
    CONSTRAINT "UX_ParentResourceExtensionRootExtChildren_RootExtChi_33ba0803c0" UNIQUE ("ParentResource_DocumentId", "RootExtChildCode")
);
...
CREATE TABLE IF NOT EXISTS "edfi"."ParentResourceParentChildren"
(
    "CollectionItemId" bigint NOT NULL DEFAULT nextval('"dms"."CollectionItemIdSequence"'),
    "Ordinal" integer NOT NULL,
    ...
    CONSTRAINT "UX_ParentResourceParentChildren_ChildCode_ParentColl_e1c321757c" UNIQUE ("ParentCollectionItemId", "ChildCode"),
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint
        WHERE conname = 'FK_ParentResourceExtension_ParentResource'
        AND conrelid = to_regclass('"rootext"."ParentResourceExtension"')
    )
    THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint
        WHERE conname = 'FK_ParentResourceExtensionRootExtChildren_ParentReso_20e284482b'
        AND conrelid = to_regclass('"rootext"."ParentResourceExtensionRootExtChildren"')
    )
    THEN
        ALTER TABLE "rootext"."ParentResourceExtensionRootExtChildren"
        ADD CONSTRAINT "FK_ParentResourceExtensionRootExtChildren_ParentReso_20e284482b"
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint
        WHERE conname = 'FK_ParentResourceParentChildren_ParentResourceParent'
        AND conrelid = to_regclass('"edfi"."ParentResourceParentChildren"')
    )
    THEN
...
CREATE OR REPLACE FUNCTION "edfi"."TF_TR_ParentResourceParentChildren_Stamp_ins"()
RETURNS TRIGGER AS $func$
BEGIN
    WITH affected AS (
        SELECT DISTINCT newtab."ParentResource_DocumentId" AS "DocumentId"
...
CREATE OR REPLACE FUNCTION "edfi"."TF_TR_ParentResourceParentChildren_Stamp_upd"()
RETURNS TRIGGER AS $func$
BEGIN
    WITH affected AS (
        SELECT n."ParentResource_DocumentId" AS "DocumentId"
...
CREATE OR REPLACE FUNCTION "edfi"."TF_TR_ParentResourceParentChildren_Stamp_del"()
RETURNS TRIGGER AS $func$
BEGIN
    WITH affected AS (
        SELECT DISTINCT oldtab."ParentResource_DocumentId" AS "DocumentId"
...
DROP TRIGGER IF EXISTS "TR_ParentResourceParentChildren_Stamp" ON "edfi"."ParentResourceParentChildren";
DROP TRIGGER IF EXISTS "TR_ParentResourceParentChildren_Stamp_ins" ON "edfi"."ParentResourceParentChildren";
CREATE TRIGGER "TR_ParentResourceParentChildren_Stamp_ins"
AFTER INSERT ON "edfi"."ParentResourceParentChildren"
REFERENCING NEW TABLE AS newtab
FOR EACH STATEMENT
EXECUTE FUNCTION "edfi"."TF_TR_ParentResourceParentChildren_Stamp_ins"();

DROP TRIGGER IF EXISTS "TR_ParentResourceParentChildren_Stamp_upd" ON "edfi"."ParentResourceParentChildren";
CREATE TRIGGER "TR_ParentResourceParentChildren_Stamp_upd"
AFTER UPDATE ON "edfi"."ParentResourceParentChildren"
REFERENCING OLD TABLE AS oldtab NEW TABLE AS newtab
FOR EACH STATEMENT
EXECUTE FUNCTION "edfi"."TF_TR_ParentResourceParentChildren_Stamp_upd"();

DROP TRIGGER IF EXISTS "TR_ParentResourceParentChildren_Stamp_del" ON "edfi"."ParentResourceParentChildren";
CREATE TRIGGER "TR_ParentResourceParentChildren_Stamp_del"
AFTER DELETE ON "edfi"."ParentResourceParentChildren"
REFERENCING OLD TABLE AS oldtab
FOR EACH STATEMENT
EXECUTE FUNCTION "edfi"."TF_TR_ParentResourceParentChildren_Stamp_del"();

CREATE OR REPLACE FUNCTION "rootext"."TF_TR_ParentResourceExtension_Stamp_ins"()
RETURNS TRIGGER AS $func$
BEGIN
    WITH affected AS (
...
CREATE OR REPLACE FUNCTION "rootext"."TF_TR_ParentResourceExtension_Stamp_upd"()
RETURNS TRIGGER AS $func$
BEGIN
    WITH affected AS (
        ...
        WHERE o."DocumentId" IS NULL OR n."DocumentId" IS DISTINCT FROM o."DocumentId" OR n."RootExtHiddenScalar" IS DISTINCT FROM o."RootExtHiddenScalar" OR n."RootExtVisibleScalar" IS DISTINCT FROM o."RootExtVisibleScalar"
        UNION
        SELECT o."DocumentId" AS "DocumentId"
        FROM oldtab o
        LEFT JOIN newtab n ON n."DocumentId" = o."DocumentId"
        WHERE n."DocumentId" IS NULL OR n."DocumentId" IS DISTINCT FROM o."DocumentId" OR n."RootExtHiddenScalar" IS DISTINCT FROM o."RootExtHiddenScalar" OR n."RootExtVisibleScalar" IS DISTINCT FROM o."RootExtVisibleScalar"
    ),
    stamped AS (
        UPDATE "dms"."Document" d
        SET "ContentVersion" = nextval('"dms"."ChangeVersionSequence"'), "ContentLastModifiedAt" = now()
...
CREATE OR REPLACE FUNCTION "rootext"."TF_TR_ParentResourceExtension_Stamp_del"()
RETURNS TRIGGER AS $func$
BEGIN
    WITH affected AS (
...
DROP TRIGGER IF EXISTS "TR_ParentResourceExtension_Stamp" ON "rootext"."ParentResourceExtension";
DROP TRIGGER IF EXISTS "TR_ParentResourceExtension_Stamp_ins" ON "rootext"."ParentResourceExtension";
CREATE TRIGGER "TR_ParentResourceExtension_Stamp_ins"
AFTER INSERT ON "rootext"."ParentResourceExtension"
REFERENCING NEW TABLE AS newtab
FOR EACH STATEMENT
EXECUTE FUNCTION "rootext"."TF_TR_ParentResourceExtension_Stamp_ins"();

DROP TRIGGER IF EXISTS "TR_ParentResourceExtension_Stamp_upd" ON "rootext"."ParentResourceExtension";
CREATE TRIGGER "TR_ParentResourceExtension_Stamp_upd"
AFTER UPDATE ON "rootext"."ParentResourceExtension"
REFERENCING OLD TABLE AS oldtab NEW TABLE AS newtab
FOR EACH STATEMENT
EXECUTE FUNCTION "rootext"."TF_TR_ParentResourceExtension_Stamp_upd"();

DROP TRIGGER IF EXISTS "TR_ParentResourceExtension_Stamp_del" ON "rootext"."ParentResourceExtension";
CREATE TRIGGER "TR_ParentResourceExtension_Stamp_del"
AFTER DELETE ON "rootext"."ParentResourceExtension"
REFERENCING OLD TABLE AS oldtab
FOR EACH STATEMENT
EXECUTE FUNCTION "rootext"."TF_TR_ParentResourceExtension_Stamp_del"();

CREATE OR REPLACE FUNCTION "rootext"."TF_TR_ParentResourceExtensionRootExtChildren_Stamp_ins"()
RETURNS TRIGGER AS $func$
BEGIN
    WITH affected AS (
        SELECT DISTINCT newtab."ParentResource_DocumentId" AS "DocumentId"
...
CREATE OR REPLACE FUNCTION "rootext"."TF_TR_ParentResourceExtensionRootExtChildren_Stamp_upd"()
RETURNS TRIGGER AS $func$
BEGIN
    WITH affected AS (
        SELECT n."ParentResource_DocumentId" AS "DocumentId"
        FROM newtab n
        LEFT JOIN oldtab o ON o."CollectionItemId" = n."CollectionItemId"
        WHERE o."CollectionItemId" IS NULL OR n."CollectionItemId" IS DISTINCT FROM o."CollectionItemId" OR n."Ordinal" IS DISTINCT FROM o."Ordinal" OR n."ParentResource_DocumentId" IS DISTINCT FROM o."ParentResource_DocumentId" OR n."RootExtChildCode" IS DISTINCT FROM o."RootExtChildCode" OR n."RootExtChildValue" IS DISTINCT FROM o."RootExtChildValue"
        UNION
        SELECT o."ParentResource_DocumentId" AS "DocumentId"
        FROM oldtab o
        LEFT JOIN newtab n ON n."CollectionItemId" = o."CollectionItemId"
        WHERE n."CollectionItemId" IS NULL OR n."CollectionItemId" IS DISTINCT FROM o."CollectionItemId" OR n."Ordinal" IS DISTINCT FROM o."Ordinal" OR n."ParentResource_DocumentId" IS DISTINCT FROM o."ParentResource_DocumentId" OR n."RootExtChildCode" IS DISTINCT FROM o."RootExtChildCode" OR n."RootExtChildValue" IS DISTINCT FROM o."RootExtChildValue"
    ),
    stamped AS (
        UPDATE "dms"."Document" d
        SET "ContentVersion" = nextval('"dms"."ChangeVersionSequence"'), "ContentLastModifiedAt" = now()
...
CREATE OR REPLACE FUNCTION "rootext"."TF_TR_ParentResourceExtensionRootExtChildren_Stamp_del"()
RETURNS TRIGGER AS $func$
BEGIN
    WITH affected AS (
        SELECT DISTINCT oldtab."ParentResource_DocumentId" AS "DocumentId"
...
DROP TRIGGER IF EXISTS "TR_ParentResourceExtensionRootExtChildren_Stamp" ON "rootext"."ParentResourceExtensionRootExtChildren";
DROP TRIGGER IF EXISTS "TR_ParentResourceExtensionRootExtChildren_Stamp_ins" ON "rootext"."ParentResourceExtensionRootExtChildren";
CREATE TRIGGER "TR_ParentResourceExtensionRootExtChildren_Stamp_ins"
AFTER INSERT ON "rootext"."ParentResourceExtensionRootExtChildren"
REFERENCING NEW TABLE AS newtab
FOR EACH STATEMENT
EXECUTE FUNCTION "rootext"."TF_TR_ParentResourceExtensionRootExtChildren_Stamp_ins"();

DROP TRIGGER IF EXISTS "TR_ParentResourceExtensionRootExtChildren_Stamp_upd" ON "rootext"."ParentResourceExtensionRootExtChildren";
CREATE TRIGGER "TR_ParentResourceExtensionRootExtChildren_Stamp_upd"
AFTER UPDATE ON "rootext"."ParentResourceExtensionRootExtChildren"
REFERENCING OLD TABLE AS oldtab NEW TABLE AS newtab
FOR EACH STATEMENT
EXECUTE FUNCTION "rootext"."TF_TR_ParentResourceExtensionRootExtChildren_Stamp_upd"();

DROP TRIGGER IF EXISTS "TR_ParentResourceExtensionRootExtChildren_Stamp_del" ON "rootext"."ParentResourceExtensionRootExtChildren";
CREATE TRIGGER "TR_ParentResourceExtensionRootExtChildren_Stamp_del"
AFTER DELETE ON "rootext"."ParentResourceExtensionRootExtChildren"
REFERENCING OLD TABLE AS oldtab
FOR EACH STATEMENT
...
VALUES (1, '1.0.0', '3440540b5709531eda900de5f0ff11466c14e92c5c7d114d30cff155d27cdac3', 1, '\xAA4516A2188A393B97F346BD6483E8A82E57AB430F5377D00B6409E307A812DC'::bytea)
...
VALUES ('3440540b5709531eda900de5f0ff11466c14e92c5c7d114d30cff155d27cdac3', 'ed-fi', 'Ed-Fi', '1.0.0', false)
ON CONFLICT ("EffectiveSchemaHash", "ProjectEndpointName") DO NOTHING;
INSERT INTO "dms"."SchemaComponent" ("EffectiveSchemaHash", "ProjectEndpointName", "ProjectName", "ProjectVersion", "IsExtensionProject")
VALUES ('3440540b5709531eda900de5f0ff11466c14e92c5c7d114d30cff155d27cdac3', 'root_ext', 'RootExt', '1.0.0', true)
ON CONFLICT ("EffectiveSchemaHash", "ProjectEndpointName") DO NOTHING;
...
BEGIN
    SELECT COUNT(*) INTO _actual_count FROM "dms"."SchemaComponent" WHERE "EffectiveSchemaHash" = '3440540b5709531eda900de5f0ff11466c14e92c5c7d114d30cff155d27cdac3';
    ...
    WHERE sc."EffectiveSchemaHash" = '3440540b5709531eda900de5f0ff11466c14e92c5c7d114d30cff155d27cdac3'
    AND NOT EXISTS (
        SELECT 1 FROM (VALUES
            ('ed-fi', 'Ed-Fi', '1.0.0', false),
            ('root_ext', 'RootExt', '1.0.0', true)
