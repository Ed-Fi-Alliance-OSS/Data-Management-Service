...
BEGIN
    ...
    IF @preflight_stored_hash IS NOT NULL AND @preflight_stored_hash <> N'afd5034a0630ba03994e2a9fc99b4802906af1958be0a488a2214af863f2056f'
    BEGIN
        DECLARE @preflight_msg nvarchar(500) = CONCAT(N'EffectiveSchemaHash mismatch: database has ''', @preflight_stored_hash, N''' but expected ''', N'afd5034a0630ba03994e2a9fc99b4802906af1958be0a488a2214af863f2056f', N'''');
...
IF NOT EXISTS (SELECT 1 FROM sys.schemas WHERE name = N'aligned')
...
IF OBJECT_ID(N'edfi.ParentResourceParent', N'U') IS NULL
CREATE TABLE [edfi].[ParentResourceParent]
(
...
IF OBJECT_ID(N'aligned.ParentResourceExtensionParent', N'U') IS NULL
CREATE TABLE [aligned].[ParentResourceExtensionParent]
(
    [BaseCollectionItemId] bigint NOT NULL,
    [ParentResource_DocumentId] bigint NOT NULL,
    [AlignedHiddenScalar] nvarchar(100) NULL,
    [AlignedVisibleScalar] nvarchar(100) NULL,
    CONSTRAINT [PK_ParentResourceExtensionParent] PRIMARY KEY ([BaseCollectionItemId]),
    CONSTRAINT [UX_ParentResourceExtensionParent_BaseCollectionItemId_ParentResource_DocumentId] UNIQUE ([BaseCollectionItemId], [ParentResource_DocumentId])
);

IF OBJECT_ID(N'aligned.ParentResourceExtensionParentChildren', N'U') IS NULL
CREATE TABLE [aligned].[ParentResourceExtensionParentChildren]
(
    [CollectionItemId] bigint NOT NULL DEFAULT (NEXT VALUE FOR [dms].[CollectionItemIdSequence]),
    [BaseCollectionItemId] bigint NOT NULL,
    [Ordinal] int NOT NULL,
    [ParentResource_DocumentId] bigint NOT NULL,
    [ChildCode] nvarchar(30) NULL,
    [ChildValue] nvarchar(100) NULL,
    CONSTRAINT [PK_ParentResourceExtensionParentChildren] PRIMARY KEY ([CollectionItemId]),
    CONSTRAINT [UX_ParentResourceExtensionParentChildren_BaseCollectionItemId_ChildCode] UNIQUE ([BaseCollectionItemId], [ChildCode]),
    CONSTRAINT [UX_ParentResourceExtensionParentChildren_BaseCollectionItemId_Ordinal] UNIQUE ([BaseCollectionItemId], [Ordinal]),
    CONSTRAINT [UX_ParentResourceExtensionParentChildren_CollectionItemId_ParentResource_DocumentId] UNIQUE ([CollectionItemId], [ParentResource_DocumentId])
);

IF OBJECT_ID(N'aligned.ParentResourceExtensionParentChildrenExtensionChildren', N'U') IS NULL
CREATE TABLE [aligned].[ParentResourceExtensionParentChildrenExtensionChildren]
(
    [CollectionItemId] bigint NOT NULL DEFAULT (NEXT VALUE FOR [dms].[CollectionItemIdSequence]),
    [Ordinal] int NOT NULL,
    [ParentCollectionItemId] bigint NOT NULL,
    [ParentResource_DocumentId] bigint NOT NULL,
    [ExtensionChildCode] nvarchar(30) NULL,
    [ExtensionChildValue] nvarchar(100) NULL,
    CONSTRAINT [PK_ParentResourceExtensionParentChildrenExtensionChildren] PRIMARY KEY ([CollectionItemId]),
    CONSTRAINT [UX_ParentResourceExtensionParentChildrenExtensionChildren_ExtensionChildCode_ParentCollectionItemId] UNIQUE ([ParentCollectionItemId], [ExtensionChildCode]),
    CONSTRAINT [UX_ParentResourceExtensionParentChildrenExtensionChildren_Ordinal_ParentCollectionItemId] UNIQUE ([ParentCollectionItemId], [Ordinal])
);
...
IF NOT EXISTS (
    SELECT 1 FROM sys.foreign_keys
    WHERE name = N'FK_ParentResourceParent_ParentResource' AND parent_object_id = OBJECT_ID(N'edfi.ParentResourceParent')
)
...
IF NOT EXISTS (
    SELECT 1 FROM sys.foreign_keys
    WHERE name = N'FK_ParentResourceExtensionParent_ParentResourceParent' AND parent_object_id = OBJECT_ID(N'aligned.ParentResourceExtensionParent')
)
...
IF NOT EXISTS (
    SELECT 1 FROM sys.foreign_keys
    WHERE name = N'FK_ParentResourceExtensionParentChildren_ParentResourceExtensionParent' AND parent_object_id = OBJECT_ID(N'aligned.ParentResourceExtensionParentChildren')
)
ALTER TABLE [aligned].[ParentResourceExtensionParentChildren]
ADD CONSTRAINT [FK_ParentResourceExtensionParentChildren_ParentResourceExtensionParent]
FOREIGN KEY ([BaseCollectionItemId], [ParentResource_DocumentId])
...
IF NOT EXISTS (
    SELECT 1 FROM sys.foreign_keys
    WHERE name = N'FK_ParentResourceExtensionParentChildrenExtensionChildren_ParentResourceExtensionParentChildren' AND parent_object_id = OBJECT_ID(N'aligned.ParentResourceExtensionParentChildrenExtensionChildren')
)
ALTER TABLE [aligned].[ParentResourceExtensionParentChildrenExtensionChildren]
ADD CONSTRAINT [FK_ParentResourceExtensionParentChildrenExtensionChildren_ParentResourceExtensionParentChildren]
...
IF NOT EXISTS (
    ...
    JOIN sys.tables t ON i.object_id = t.object_id
    JOIN sys.schemas s ON t.schema_id = s.schema_id
    WHERE s.name = N'aligned' AND t.name = N'ParentResourceExtensionParentChildren' AND i.name = N'IX_ParentResourceExtensionParentChildren_BaseCollectionItemId_ParentResource_DocumentId'
)
CREATE INDEX [IX_ParentResourceExtensionParentChildren_BaseCollectionItemId_ParentResource_DocumentId] ON [aligned].[ParentResourceExtensionParentChildren] ([BaseCollectionItemId], [ParentResource_DocumentId]);
...
BEGIN
    SET NOCOUNT ON;
    ;WITH affectedDocs AS (
        SELECT i.[ParentResource_DocumentId]
        FROM inserted i
        LEFT JOIN deleted del ON del.[BaseCollectionItemId] = i.[BaseCollectionItemId]
        WHERE del.[BaseCollectionItemId] IS NULL OR (i.[BaseCollectionItemId] <> del.[BaseCollectionItemId] OR (i.[BaseCollectionItemId] IS NULL AND del.[BaseCollectionItemId] IS NOT NULL) OR (i.[BaseCollectionItemId] IS NOT NULL AND del.[BaseCollectionItemId] IS NULL)) OR (i.[ParentResource_DocumentId] <> del.[ParentResource_DocumentId] OR (i.[ParentResource_DocumentId] IS NULL AND del.[ParentResource_DocumentId] IS NOT NULL) OR (i.[ParentResource_DocumentId] IS NOT NULL AND del.[ParentResource_DocumentId] IS NULL)) OR (CAST(i.[AlignedHiddenScalar] AS varbinary(max)) <> CAST(del.[AlignedHiddenScalar] AS varbinary(max)) OR (i.[AlignedHiddenScalar] IS NULL AND del.[AlignedHiddenScalar] IS NOT NULL) OR (i.[AlignedHiddenScalar] IS NOT NULL AND del.[AlignedHiddenScalar] IS NULL)) OR (CAST(i.[AlignedVisibleScalar] AS varbinary(max)) <> CAST(del.[AlignedVisibleScalar] AS varbinary(max)) OR (i.[AlignedVisibleScalar] IS NULL AND del.[AlignedVisibleScalar] IS NOT NULL) OR (i.[AlignedVisibleScalar] IS NOT NULL AND del.[AlignedVisibleScalar] IS NULL))
        UNION
        SELECT del.[ParentResource_DocumentId]
        FROM deleted del
    ...
    SET d.[ContentVersion] = NEXT VALUE FOR [dms].[ChangeVersionSequence], d.[ContentLastModifiedAt] = sysutcdatetime()
    FROM [dms].[Document] d
    INNER JOIN affectedDocs a ON d.[DocumentId] = a.[ParentResource_DocumentId];
END;
GO

CREATE OR ALTER TRIGGER [aligned].[TR_ParentResourceExtensionParentChildren_Stamp]
ON [aligned].[ParentResourceExtensionParentChildren]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
    SET NOCOUNT ON;
    ;WITH affectedDocs AS (
        ...
        WHERE del.[CollectionItemId] IS NULL OR (i.[CollectionItemId] <> del.[CollectionItemId] OR (i.[CollectionItemId] IS NULL AND del.[CollectionItemId] IS NOT NULL) OR (i.[CollectionItemId] IS NOT NULL AND del.[CollectionItemId] IS NULL)) OR (i.[BaseCollectionItemId] <> del.[BaseCollectionItemId] OR (i.[BaseCollectionItemId] IS NULL AND del.[BaseCollectionItemId] IS NOT NULL) OR (i.[BaseCollectionItemId] IS NOT NULL AND del.[BaseCollectionItemId] IS NULL)) OR (i.[Ordinal] <> del.[Ordinal] OR (i.[Ordinal] IS NULL AND del.[Ordinal] IS NOT NULL) OR (i.[Ordinal] IS NOT NULL AND del.[Ordinal] IS NULL)) OR (i.[ParentResource_DocumentId] <> del.[ParentResource_DocumentId] OR (i.[ParentResource_DocumentId] IS NULL AND del.[ParentResource_DocumentId] IS NOT NULL) OR (i.[ParentResource_DocumentId] IS NOT NULL AND del.[ParentResource_DocumentId] IS NULL)) OR (CAST(i.[ChildCode] AS varbinary(max)) <> CAST(del.[ChildCode] AS varbinary(max)) OR (i.[ChildCode] IS NULL AND del.[ChildCode] IS NOT NULL) OR (i.[ChildCode] IS NOT NULL AND del.[ChildCode] IS NULL)) OR (CAST(i.[ChildValue] AS varbinary(max)) <> CAST(del.[ChildValue] AS varbinary(max)) OR (i.[ChildValue] IS NULL AND del.[ChildValue] IS NOT NULL) OR (i.[ChildValue] IS NOT NULL AND del.[ChildValue] IS NULL))
        UNION
        SELECT del.[ParentResource_DocumentId]
        FROM deleted del
...
CREATE OR ALTER TRIGGER [aligned].[TR_ParentResourceExtensionParentChildrenExtensionChildren_Stamp]
ON [aligned].[ParentResourceExtensionParentChildrenExtensionChildren]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
    SET NOCOUNT ON;
    ;WITH affectedDocs AS (
        ...
        FROM inserted i
        LEFT JOIN deleted del ON del.[CollectionItemId] = i.[CollectionItemId]
        WHERE del.[CollectionItemId] IS NULL OR (i.[CollectionItemId] <> del.[CollectionItemId] OR (i.[CollectionItemId] IS NULL AND del.[CollectionItemId] IS NOT NULL) OR (i.[CollectionItemId] IS NOT NULL AND del.[CollectionItemId] IS NULL)) OR (i.[Ordinal] <> del.[Ordinal] OR (i.[Ordinal] IS NULL AND del.[Ordinal] IS NOT NULL) OR (i.[Ordinal] IS NOT NULL AND del.[Ordinal] IS NULL)) OR (i.[ParentCollectionItemId] <> del.[ParentCollectionItemId] OR (i.[ParentCollectionItemId] IS NULL AND del.[ParentCollectionItemId] IS NOT NULL) OR (i.[ParentCollectionItemId] IS NOT NULL AND del.[ParentCollectionItemId] IS NULL)) OR (i.[ParentResource_DocumentId] <> del.[ParentResource_DocumentId] OR (i.[ParentResource_DocumentId] IS NULL AND del.[ParentResource_DocumentId] IS NOT NULL) OR (i.[ParentResource_DocumentId] IS NOT NULL AND del.[ParentResource_DocumentId] IS NULL)) OR (CAST(i.[ExtensionChildCode] AS varbinary(max)) <> CAST(del.[ExtensionChildCode] AS varbinary(max)) OR (i.[ExtensionChildCode] IS NULL AND del.[ExtensionChildCode] IS NOT NULL) OR (i.[ExtensionChildCode] IS NOT NULL AND del.[ExtensionChildCode] IS NULL)) OR (CAST(i.[ExtensionChildValue] AS varbinary(max)) <> CAST(del.[ExtensionChildValue] AS varbinary(max)) OR (i.[ExtensionChildValue] IS NULL AND del.[ExtensionChildValue] IS NOT NULL) OR (i.[ExtensionChildValue] IS NOT NULL AND del.[ExtensionChildValue] IS NULL))
        UNION
        SELECT del.[ParentResource_DocumentId]
        FROM deleted del
        LEFT JOIN inserted i ON i.[CollectionItemId] = del.[CollectionItemId]
        WHERE i.[CollectionItemId] IS NULL OR (i.[CollectionItemId] <> del.[CollectionItemId] OR (i.[CollectionItemId] IS NULL AND del.[CollectionItemId] IS NOT NULL) OR (i.[CollectionItemId] IS NOT NULL AND del.[CollectionItemId] IS NULL)) OR (i.[Ordinal] <> del.[Ordinal] OR (i.[Ordinal] IS NULL AND del.[Ordinal] IS NOT NULL) OR (i.[Ordinal] IS NOT NULL AND del.[Ordinal] IS NULL)) OR (i.[ParentCollectionItemId] <> del.[ParentCollectionItemId] OR (i.[ParentCollectionItemId] IS NULL AND del.[ParentCollectionItemId] IS NOT NULL) OR (i.[ParentCollectionItemId] IS NOT NULL AND del.[ParentCollectionItemId] IS NULL)) OR (i.[ParentResource_DocumentId] <> del.[ParentResource_DocumentId] OR (i.[ParentResource_DocumentId] IS NULL AND del.[ParentResource_DocumentId] IS NOT NULL) OR (i.[ParentResource_DocumentId] IS NOT NULL AND del.[ParentResource_DocumentId] IS NULL)) OR (CAST(i.[ExtensionChildCode] AS varbinary(max)) <> CAST(del.[ExtensionChildCode] AS varbinary(max)) OR (i.[ExtensionChildCode] IS NULL AND del.[ExtensionChildCode] IS NOT NULL) OR (i.[ExtensionChildCode] IS NOT NULL AND del.[ExtensionChildCode] IS NULL)) OR (CAST(i.[ExtensionChildValue] AS varbinary(max)) <> CAST(del.[ExtensionChildValue] AS varbinary(max)) OR (i.[ExtensionChildValue] IS NULL AND del.[ExtensionChildValue] IS NOT NULL) OR (i.[ExtensionChildValue] IS NOT NULL AND del.[ExtensionChildValue] IS NULL))
    )
    UPDATE d
    SET d.[ContentVersion] = NEXT VALUE FOR [dms].[ChangeVersionSequence], d.[ContentLastModifiedAt] = sysutcdatetime()
    FROM [dms].[Document] d
...
BEGIN
    ...
    ;WITH affectedDocs AS (
        ...
        FROM inserted i
        LEFT JOIN deleted del ON del.[DocumentId] = i.[DocumentId]
        WHERE del.[DocumentId] IS NULL OR (i.[DocumentId] <> del.[DocumentId] OR (i.[DocumentId] IS NULL AND del.[DocumentId] IS NOT NULL) OR (i.[DocumentId] IS NOT NULL AND del.[DocumentId] IS NULL)) OR (i.[ParentResourceId] <> del.[ParentResourceId] OR (i.[ParentResourceId] IS NULL AND del.[ParentResourceId] IS NOT NULL) OR (i.[ParentResourceId] IS NOT NULL AND del.[ParentResourceId] IS NULL))
        UNION
        SELECT del.[DocumentId]
        FROM deleted del
        LEFT JOIN inserted i ON i.[DocumentId] = del.[DocumentId]
        WHERE i.[DocumentId] IS NULL OR (i.[DocumentId] <> del.[DocumentId] OR (i.[DocumentId] IS NULL AND del.[DocumentId] IS NOT NULL) OR (i.[DocumentId] IS NOT NULL AND del.[DocumentId] IS NULL)) OR (i.[ParentResourceId] <> del.[ParentResourceId] OR (i.[ParentResourceId] IS NULL AND del.[ParentResourceId] IS NOT NULL) OR (i.[ParentResourceId] IS NOT NULL AND del.[ParentResourceId] IS NULL))
    )
    UPDATE d
    SET d.[ContentVersion] = NEXT VALUE FOR [dms].[ChangeVersionSequence], d.[ContentLastModifiedAt] = sysutcdatetime()
    FROM [dms].[Document] d
    INNER JOIN affectedDocs a ON d.[DocumentId] = a.[DocumentId];
    IF EXISTS (SELECT 1 FROM deleted) AND (UPDATE([ParentResourceId]))
    BEGIN
        UPDATE d
...
CREATE OR ALTER TRIGGER [edfi].[TR_ParentResourceParent_Stamp]
ON [edfi].[ParentResourceParent]
AFTER INSERT, UPDATE, DELETE
AS
BEGIN
    SET NOCOUNT ON;
    ;WITH affectedDocs AS (
        ...
        FROM inserted i
        LEFT JOIN deleted del ON del.[CollectionItemId] = i.[CollectionItemId]
        WHERE del.[CollectionItemId] IS NULL OR (i.[CollectionItemId] <> del.[CollectionItemId] OR (i.[CollectionItemId] IS NULL AND del.[CollectionItemId] IS NOT NULL) OR (i.[CollectionItemId] IS NOT NULL AND del.[CollectionItemId] IS NULL)) OR (i.[Ordinal] <> del.[Ordinal] OR (i.[Ordinal] IS NULL AND del.[Ordinal] IS NOT NULL) OR (i.[Ordinal] IS NOT NULL AND del.[Ordinal] IS NULL)) OR (i.[ParentResource_DocumentId] <> del.[ParentResource_DocumentId] OR (i.[ParentResource_DocumentId] IS NULL AND del.[ParentResource_DocumentId] IS NOT NULL) OR (i.[ParentResource_DocumentId] IS NOT NULL AND del.[ParentResource_DocumentId] IS NULL)) OR (CAST(i.[ParentCode] AS varbinary(max)) <> CAST(del.[ParentCode] AS varbinary(max)) OR (i.[ParentCode] IS NULL AND del.[ParentCode] IS NOT NULL) OR (i.[ParentCode] IS NOT NULL AND del.[ParentCode] IS NULL)) OR (CAST(i.[ParentName] AS varbinary(max)) <> CAST(del.[ParentName] AS varbinary(max)) OR (i.[ParentName] IS NULL AND del.[ParentName] IS NOT NULL) OR (i.[ParentName] IS NOT NULL AND del.[ParentName] IS NULL))
        UNION
        SELECT del.[ParentResource_DocumentId]
        FROM deleted del
        LEFT JOIN inserted i ON i.[CollectionItemId] = del.[CollectionItemId]
        WHERE i.[CollectionItemId] IS NULL OR (i.[CollectionItemId] <> del.[CollectionItemId] OR (i.[CollectionItemId] IS NULL AND del.[CollectionItemId] IS NOT NULL) OR (i.[CollectionItemId] IS NOT NULL AND del.[CollectionItemId] IS NULL)) OR (i.[Ordinal] <> del.[Ordinal] OR (i.[Ordinal] IS NULL AND del.[Ordinal] IS NOT NULL) OR (i.[Ordinal] IS NOT NULL AND del.[Ordinal] IS NULL)) OR (i.[ParentResource_DocumentId] <> del.[ParentResource_DocumentId] OR (i.[ParentResource_DocumentId] IS NULL AND del.[ParentResource_DocumentId] IS NOT NULL) OR (i.[ParentResource_DocumentId] IS NOT NULL AND del.[ParentResource_DocumentId] IS NULL)) OR (CAST(i.[ParentCode] AS varbinary(max)) <> CAST(del.[ParentCode] AS varbinary(max)) OR (i.[ParentCode] IS NULL AND del.[ParentCode] IS NOT NULL) OR (i.[ParentCode] IS NOT NULL AND del.[ParentCode] IS NULL)) OR (CAST(i.[ParentName] AS varbinary(max)) <> CAST(del.[ParentName] AS varbinary(max)) OR (i.[ParentName] IS NULL AND del.[ParentName] IS NOT NULL) OR (i.[ParentName] IS NOT NULL AND del.[ParentName] IS NULL))
    )
    UPDATE d
    SET d.[ContentVersion] = NEXT VALUE FOR [dms].[ChangeVersionSequence], d.[ContentLastModifiedAt] = sysutcdatetime()
    FROM [dms].[Document] d
...
IF NOT EXISTS (SELECT 1 FROM [dms].[ResourceKey] WHERE [ResourceKeyId] = 1)
    ...
    VALUES (1, N'Ed-Fi', N'ParentResource', N'1.0.0');
...
WHERE NOT EXISTS (
    SELECT 1 FROM (VALUES
        (1, N'Ed-Fi', N'ParentResource', N'1.0.0')
...
IF NOT EXISTS (SELECT 1 FROM [dms].[EffectiveSchema] WHERE [EffectiveSchemaSingletonId] = 1)
    ...
    VALUES (1, N'1.0.0', N'afd5034a0630ba03994e2a9fc99b4802906af1958be0a488a2214af863f2056f', 1, 0xAA4516A2188A393B97F346BD6483E8A82E57AB430F5377D00B6409E307A812DC);
...
BEGIN
    ...
    END
    IF @es_stored_hash <> 0xAA4516A2188A393B97F346BD6483E8A82E57AB430F5377D00B6409E307A812DC
    BEGIN
        DECLARE @es_hash_msg nvarchar(200) = CONCAT(N'dms.EffectiveSchema ResourceKeySeedHash mismatch: stored ', CONVERT(nvarchar(66), @es_stored_hash, 1), N' but expected ', CONVERT(nvarchar(66), 0xAA4516A2188A393B97F346BD6483E8A82E57AB430F5377D00B6409E307A812DC, 1));
        THROW 50000, @es_hash_msg, 1;
    END
END

-- SchemaComponent seed inserts (insert-if-missing)
IF NOT EXISTS (SELECT 1 FROM [dms].[SchemaComponent] WHERE [EffectiveSchemaHash] = N'afd5034a0630ba03994e2a9fc99b4802906af1958be0a488a2214af863f2056f' AND [ProjectEndpointName] = N'aligned')
    INSERT INTO [dms].[SchemaComponent] ([EffectiveSchemaHash], [ProjectEndpointName], [ProjectName], [ProjectVersion], [IsExtensionProject])
    VALUES (N'afd5034a0630ba03994e2a9fc99b4802906af1958be0a488a2214af863f2056f', N'aligned', N'Aligned', N'1.0.0', 1);
IF NOT EXISTS (SELECT 1 FROM [dms].[SchemaComponent] WHERE [EffectiveSchemaHash] = N'afd5034a0630ba03994e2a9fc99b4802906af1958be0a488a2214af863f2056f' AND [ProjectEndpointName] = N'ed-fi')
    INSERT INTO [dms].[SchemaComponent] ([EffectiveSchemaHash], [ProjectEndpointName], [ProjectName], [ProjectVersion], [IsExtensionProject])
    VALUES (N'afd5034a0630ba03994e2a9fc99b4802906af1958be0a488a2214af863f2056f', N'ed-fi', N'Ed-Fi', N'1.0.0', 0);
...
SELECT @sc_actual_count = COUNT(*) FROM [dms].[SchemaComponent] WHERE [EffectiveSchemaHash] = N'afd5034a0630ba03994e2a9fc99b4802906af1958be0a488a2214af863f2056f';
...
WHERE sc.[EffectiveSchemaHash] = N'afd5034a0630ba03994e2a9fc99b4802906af1958be0a488a2214af863f2056f'
AND NOT EXISTS (
    SELECT 1 FROM (VALUES
