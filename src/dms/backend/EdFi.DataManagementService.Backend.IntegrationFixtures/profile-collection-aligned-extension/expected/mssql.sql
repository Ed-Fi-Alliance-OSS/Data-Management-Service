...
BEGIN
    ...
    IF @preflight_stored_hash IS NOT NULL AND @preflight_stored_hash <> N'fd94937b387157d29584a4054ece7386daade2288198cdb34742981fc840bbf3'
    BEGIN
        DECLARE @preflight_msg nvarchar(500) = CONCAT(N'EffectiveSchemaHash mismatch: database has ''', @preflight_stored_hash, N''' but expected ''', N'fd94937b387157d29584a4054ece7386daade2288198cdb34742981fc840bbf3', N'''');
...
BEGIN
    ...
    WHERE [EffectiveSchemaSingletonId] = 1;
    IF @preflight_completed_hash = N'fd94937b387157d29584a4054ece7386daade2288198cdb34742981fc840bbf3'
    BEGIN
...
BEGIN
    ...
    LEFT JOIN deleted del ON del.[DocumentId] = i.[DocumentId]
    WHERE del.[DocumentId] IS NULL;
    IF EXISTS (SELECT 1 FROM deleted) AND (NOT EXISTS (SELECT 1 FROM inserted) OR UPDATE([DocumentId]) OR UPDATE([ParentResourceId]))
    BEGIN
        ;WITH affectedDocs AS (
            SELECT i.[DocumentId]
            FROM inserted i
...
IF NOT EXISTS (SELECT 1 FROM [dms].[EffectiveSchema] WHERE [EffectiveSchemaSingletonId] = 1)
    ...
    VALUES (1, N'1.0.0', N'fd94937b387157d29584a4054ece7386daade2288198cdb34742981fc840bbf3', 1, 0xAA4516A2188A393B97F346BD6483E8A82E57AB430F5377D00B6409E307A812DC);
...
IF NOT EXISTS (SELECT 1 FROM [dms].[SchemaComponent] WHERE [EffectiveSchemaHash] = N'fd94937b387157d29584a4054ece7386daade2288198cdb34742981fc840bbf3' AND [ProjectEndpointName] = N'aligned')
    INSERT INTO [dms].[SchemaComponent] ([EffectiveSchemaHash], [ProjectEndpointName], [ProjectName], [ProjectVersion], [IsExtensionProject])
    VALUES (N'fd94937b387157d29584a4054ece7386daade2288198cdb34742981fc840bbf3', N'aligned', N'Aligned', N'1.0.0', 1);
IF NOT EXISTS (SELECT 1 FROM [dms].[SchemaComponent] WHERE [EffectiveSchemaHash] = N'fd94937b387157d29584a4054ece7386daade2288198cdb34742981fc840bbf3' AND [ProjectEndpointName] = N'ed-fi')
    INSERT INTO [dms].[SchemaComponent] ([EffectiveSchemaHash], [ProjectEndpointName], [ProjectName], [ProjectVersion], [IsExtensionProject])
    VALUES (N'fd94937b387157d29584a4054ece7386daade2288198cdb34742981fc840bbf3', N'ed-fi', N'Ed-Fi', N'1.0.0', 0);
...
SELECT @sc_actual_count = COUNT(*) FROM [dms].[SchemaComponent] WHERE [EffectiveSchemaHash] = N'fd94937b387157d29584a4054ece7386daade2288198cdb34742981fc840bbf3';
...
WHERE sc.[EffectiveSchemaHash] = N'fd94937b387157d29584a4054ece7386daade2288198cdb34742981fc840bbf3'
AND NOT EXISTS (
    SELECT 1 FROM (VALUES
