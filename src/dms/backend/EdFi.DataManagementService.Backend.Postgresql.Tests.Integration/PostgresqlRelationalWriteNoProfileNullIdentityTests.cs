...
file sealed class NoProfileNullIdentityHostApplicationLifetime : IHostApplicationLifetime
{
...
file sealed class NoProfileNullIdentityAllowAllResourceAuthorizationHandler : IResourceAuthorizationHandler
{
...
file sealed class NoProfileNullIdentityUpdateCascadeHandler : IUpdateCascadeHandler
{
...
internal sealed record NoProfileNullIdentityDocumentRow(
    long DocumentId,
    Guid DocumentUuid,
    short ResourceKeyId,
    long ContentVersion
...
internal sealed record NoProfileNullIdentitySchoolAddressRow(
...
file static class NoProfileNullIdentityIntegrationTestSupport
{
    ...
    public static ServiceProvider CreateServiceProvider()
    {
        ...
        services.AddSingleton<IHostApplicationLifetime, NoProfileNullIdentityHostApplicationLifetime>();
    ...
    )
    {
        ...
        return new UpsertRequest(
            ...
            UpdateCascadeHandler: new NoProfileNullIdentityUpdateCascadeHandler(),
            ResourceAuthorizationHandler: new NoProfileNullIdentityAllowAllResourceAuthorizationHandler(),
    ...
    public static async Task<NoProfileNullIdentityDocumentRow> ReadDocumentAsync(
    ...
    )
    {
        ...
        return rows.Count == 1
            ? new NoProfileNullIdentityDocumentRow(
    ...
    public static async Task<IReadOnlyList<NoProfileNullIdentitySchoolAddressRow>> ReadSchoolAddressesAsync(
        PostgresqlGeneratedDdlTestDatabase database,
        long documentId
    )
    {
        ...
        return rows.Select(row => new NoProfileNullIdentitySchoolAddressRow(
...
public class Given_A_Postgresql_No_Profile_Null_Identity_Changed_Put
{
    ...
    private IReadOnlyList<NoProfileNullIdentitySchoolAddressRow> _addressesAfterUpdate = null!;

    [OneTimeSetUp]
    public async Task OneTimeSetUp()
    {
        _fixture = PostgresqlGeneratedDdlFixtureLoader.LoadFromRepositoryRelativePath(
            NoProfileNullIdentityIntegrationTestSupport.FixtureRelativePath
        );
        _mappingSet = _fixture.MappingSet;
        _database = await PostgresqlGeneratedDdlTestDatabase.CreateProvisionedAsync(_fixture.GeneratedDdl);
        _serviceProvider = NoProfileNullIdentityIntegrationTestSupport.CreateServiceProvider();

        // Step 1: Create the document with city = "Seed-City"
        var createResult = await ExecuteUpsertAsync(
            NoProfileNullIdentityIntegrationTestSupport.CreateRequestBodyJson,
            "pg-null-identity-changed-put-create"
        );
        createResult.Should().BeOfType<UpsertResult.InsertSuccess>();

        var documentAfterCreate = await NoProfileNullIdentityIntegrationTestSupport.ReadDocumentAsync(
            _database,
            SchoolDocumentUuid.Value
        );
        var addressesAfterCreate = await NoProfileNullIdentityIntegrationTestSupport.ReadSchoolAddressesAsync(
            _database,
        ...
        var rowsAffected = await _database.ExecuteNonQueryAsync(
            ...
            """,
            new NpgsqlParameter("id", _seededCollectionItemId)
        );
        rowsAffected.Should().Be(1);

        // Step 3: PUT with city omitted
        _updateResult = await ExecuteUpdateAsync(
            NoProfileNullIdentityIntegrationTestSupport.UpdateRequestBodyJson,
            "pg-null-identity-changed-put-update"
        );

        _addressesAfterUpdate = await NoProfileNullIdentityIntegrationTestSupport.ReadSchoolAddressesAsync(
            _database,
            documentAfterCreate.DocumentId
        );
    }
    ...
    private async Task<UpsertResult> ExecuteUpsertAsync(string requestBodyJson, string traceId)
    {
        ...
        scope
            ...
            .SetSelectedDmsInstance(
                new DmsInstance(
                    Id: 1,
                    InstanceType: "test",
                    InstanceName: "PostgresqlNoProfileNullIdentityChangedPut",
        ...
        return await repository.UpsertDocument(
            NoProfileNullIdentityIntegrationTestSupport.CreateUpsertRequest(
                _mappingSet,
                SchoolDocumentUuid,
                requestBodyJson,
                traceId
    ...
    private async Task<UpdateResult> ExecuteUpdateAsync(string requestBodyJson, string traceId)
    {
        ...
        return await repository.UpdateDocumentById(
            NoProfileNullIdentityIntegrationTestSupport.CreateUpdateRequest(
                _mappingSet,
                SchoolDocumentUuid,
                requestBodyJson,
                traceId
...
[Category("DatabaseIntegration")]
[Category("PostgresqlIntegration")]
public class Given_A_Postgresql_No_Profile_Null_Identity_Guarded_No_Op_Put
{
    private static readonly DocumentUuid SchoolDocumentUuid = new(
    ...
    private NoProfileNullIdentityDocumentRow _documentAfterNoOpPut = null!;
    private IReadOnlyList<NoProfileNullIdentitySchoolAddressRow> _addressesAfterNoOpPut = null!;
    ...
    public async Task OneTimeSetUp()
    {
        ...
        var firstUpdateResult = await ExecuteUpdateAsync(
            NoProfileNullIdentityIntegrationTestSupport.UpdateRequestBodyJson,
            "pg-null-identity-no-op-first-update"
        );
        ...
        var documentBeforeNoOpPut = await NoProfileNullIdentityIntegrationTestSupport.ReadDocumentAsync(
            _database,
            SchoolDocumentUuid.Value
        );
        ...
        _noOpUpdateResult = await ExecuteUpdateAsync(
            NoProfileNullIdentityIntegrationTestSupport.UpdateRequestBodyJson,
            "pg-null-identity-no-op-second-update"
        );

        _documentAfterNoOpPut = await NoProfileNullIdentityIntegrationTestSupport.ReadDocumentAsync(
            _database,
            SchoolDocumentUuid.Value
        );
        _addressesAfterNoOpPut = await NoProfileNullIdentityIntegrationTestSupport.ReadSchoolAddressesAsync(
            _database,
        ...
        scope
            ...
            .SetSelectedDmsInstance(
                new DmsInstance(
                    Id: 1,
                    InstanceType: "test",
                    InstanceName: "PostgresqlNoProfileNullIdentityGuardedNoOp",
                    ConnectionString: _database.ConnectionString,
                    RouteContext: []
                )
            );
...
[Category("DatabaseIntegration")]
[Category("PostgresqlIntegration")]
public class Given_A_Postgresql_No_Profile_Null_Identity_Post_As_Update
{
    ...
    private IReadOnlyList<NoProfileNullIdentitySchoolAddressRow> _addressesAfterPostAsUpdate = null!;
    ...
    public async Task OneTimeSetUp()
    {
        ...
        var createResult = await ExecuteUpsertAsync(
            ...
            "pg-null-identity-post-as-update-create"
        );
        createResult.Should().BeOfType<UpsertResult.InsertSuccess>();
        ...
        var referentialId = new ReferentialId(
            await NoProfileNullIdentityIntegrationTestSupport.ReadReferentialIdAsync(
                _database,
                documentAfterCreate.DocumentId,
                _mappingSet.ResourceKeyIdByResource[
                    NoProfileNullIdentityIntegrationTestSupport.SchoolResource
                ]
            )
        );
        ...
        _postAsUpdateResult = await ExecuteUpsertAsync(
            ...
            "pg-null-identity-post-as-update-upsert",
            referentialId
        );

        var documentAfterPostAsUpdate = await NoProfileNullIdentityIntegrationTestSupport.ReadDocumentAsync(
            _database,
            ExistingSchoolDocumentUuid.Value
        );
        _addressesAfterPostAsUpdate =
            await NoProfileNullIdentityIntegrationTestSupport.ReadSchoolAddressesAsync(
                _database,
        ...
        scope
            ...
            .SetSelectedDmsInstance(
                new DmsInstance(
                    Id: 1,
                    InstanceType: "test",
                    InstanceName: "PostgresqlNoProfileNullIdentityPostAsUpdate",
                    ConnectionString: _database.ConnectionString,
                    RouteContext: []
                )
            );
