    ...
    : PostgresqlProfileNestedFixtureBase
{
    ...
    public async Task ScenarioOneTimeSetUp()
    {
        ...
        _childRowsBeforePut = await PostgresqlProfileNestedSupport.ReadChildRowsAsync(Database, DocumentUuid);
    ...
    : PostgresqlProfileNestedFixtureBase
{
    ...
    public async Task ScenarioOneTimeSetUp()
    {
        ...
        _rootExtChildRowsBeforePut = await PostgresqlProfileNestedSupport.ReadRootExtChildRowsAsync(
            Database,
            DocumentUuid
        );
        _rootExtRowBeforePut = await PostgresqlProfileNestedSupport.TryReadRootExtRowAsync(
            Database,
            DocumentUuid
        );
