-- Two calls within one transaction: first inserts full set, second removes two entries to confirm delete branch works.
BEGIN;
    ...
    SELECT * FROM dms.InsertReferences(
        ...
        p_referentialPartitionKeys   => ARRAY[12,12,1]::smallint[],
