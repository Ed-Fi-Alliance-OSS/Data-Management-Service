...
/// <summary>
/// PostgreSQL adapter for the shared <c>FullSurfaceCollectionReorder</c> scenario. This suite owns only
/// the PostgreSQL provisioning, resolver registration, no-profile merge production-boundary invocation,
...
public class Given_A_Postgresql_Relational_Write_Full_Surface_Collection_Reorder_With_A_Focused_Stable_Key_Fixture
{
    ...
    private UpdateRequest CreateUpdateRequest() =>
        new(
            ...
            Headers: [],
            TraceId: new TraceId("pg-full-surface-reorder-update"),
            DocumentUuid: SchoolDocumentUuid
        );
