...
public sealed class Given_MessageContractRunner_prerequisites
{
    ...
    [TestCase("contract/connect@sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")]
    [TestCase(
        "credentials-sentinel@connect@sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    )]
    public void It_rejects_missing_mutable_or_unqualified_images_without_echoing_the_value(string image)
    {
