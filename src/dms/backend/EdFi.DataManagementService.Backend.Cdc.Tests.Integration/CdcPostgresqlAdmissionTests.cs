...
using static EdFi.DataManagementService.Backend.Cdc.Tests.Integration.CdcPostgresqlAdmissionFixture;
...
{
    private CdcPostgresqlAdmissionFixture _fixture = null!;
    ...
    public async Task Setup()
    {
        ...
        _fixture = await CdcPostgresqlAdmissionFixture.StartAsync(Token);
    }
