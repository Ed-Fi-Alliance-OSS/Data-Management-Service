...
) : IDocumentStoreRepository, IQueryHandler, IPartitionQueryHandler
{
    ...
    public Task<DeleteResult> DeleteDocumentById(IDeleteRequest deleteRequest)
    {
        ...
        _logger.LogDebug(
            ...
            LoggingSanitizer.SanitizeForCorrelationId(deleteRequest.TraceId.Value)
        );
    ...
    )
    {
        ...
        catch (DbException ex) when (_writeExceptionClassifier.IsTransientFailure(ex))
        {
            _logger.LogDebug(
                ...
                documentUuid.Value,
                LoggingSanitizer.SanitizeForCorrelationId(traceId.Value)
            );
    ...
    )
    {
        ...
        _logger.LogDebug(
            ...
            LoggingSanitizer.SanitizeForCorrelationId(partitionRequest.TraceId.Value)
        );
