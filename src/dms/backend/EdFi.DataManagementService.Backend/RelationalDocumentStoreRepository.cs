...
) : IDocumentStoreRepository, IQueryHandler, IPartitionQueryHandler
{
    ...
    public Task<DeleteResult> DeleteDocumentById(IDeleteRequest deleteRequest)
    {
        ...
        _logger.LogDebug(
            ...
            LoggingSanitizer.SanitizeCorrelationIdForLogging(deleteRequest.TraceId.Value)
        );
    ...
    )
    {
        ...
        _logger.LogDebug(
            ...
            LoggingSanitizer.SanitizeCorrelationIdForLogging(partitionRequest.TraceId.Value)
        );
