...
public class Given_A_Mssql_Relational_Delete_Authorization_With_A_Synthetic_EdOrg_Fixture
{
    ...
    [
        ...
        new(
            new DocumentUuid(Guid.Parse("99999999-2000-0000-0000-000000000003")),
            203,
            "delete-inverted",
            300,
            [new ClassPeriodReferenceSeed("P1", 100)]
        ...
        new(
            new DocumentUuid(Guid.Parse("99999999-2000-0000-0000-000000000007")),
            207,
        ...
        new(
            new DocumentUuid(Guid.Parse("99999999-2000-0000-0000-000000000008")),
            208,
        ...
        new(
            new DocumentUuid(Guid.Parse("99999999-2000-0000-0000-000000000009")),
            209,
            "delete-empty-claims",
            100,
            []
        ...
        new(
            new DocumentUuid(Guid.Parse("99999999-2000-0000-0000-000000000010")),
            210,
        ...
        new(
            new DocumentUuid(Guid.Parse("99999999-2000-0000-0000-000000000011")),
            211,
    ...
    private static readonly AuthorizationNullableSeed _authorizationNullableSeed = new(
        new DocumentUuid(Guid.Parse("99999999-4000-0000-0000-000000000001")),
        401,
        "stored-null"
    );

    private static readonly SchoolYearTypeSeed _schoolYearSeed = new(
        new DocumentUuid(Guid.Parse("99999999-5000-0000-0000-000000000001")),
        2026,
        true,
        "2026"
    );
    ...
    private static readonly StudentSeed _authorizedStudentSeed = new(
        new DocumentUuid(Guid.Parse("99999999-5000-0000-0000-000000000101")),
        "delete-10001",
        "Ari",
        "Able"
    );
    ...
    private static readonly StudentSeed _unauthorizedStudentSeed = new(
        new DocumentUuid(Guid.Parse("99999999-5000-0000-0000-000000000102")),
        "delete-10002",
        "Blake",
        "Baker"
    );
    ...
    private static readonly StudentSchoolAssociationSeed _authorizedStudentSchoolAssociationSeed = new(
        new DocumentUuid(Guid.Parse("99999999-5000-0000-0000-000000000201")),
    ...
    private static readonly StudentSchoolAssociationSeed _unauthorizedStudentSchoolAssociationSeed = new(
        new DocumentUuid(Guid.Parse("99999999-5000-0000-0000-000000000202")),
    ...
    private static readonly StudentAcademicRecordSeed _authorizedStudentAcademicRecordSeed = new(
        new DocumentUuid(Guid.Parse("99999999-5000-0000-0000-000000000301")),
        100,
        _schoolYearSeed.SchoolYear,
        _authorizedStudentSeed.StudentUniqueId,
        TermDescriptor
    ...
    private static readonly StudentAcademicRecordSeed _unauthorizedStudentAcademicRecordSeed = new(
        new DocumentUuid(Guid.Parse("99999999-5000-0000-0000-000000000302")),
        300,
        _schoolYearSeed.SchoolYear,
        _unauthorizedStudentSeed.StudentUniqueId,
        TermDescriptor
    ...
    [
        new(
            new DocumentUuid(Guid.Parse("99999999-5000-0000-0000-000000000401")),
            501,
        ...
        new(
            new DocumentUuid(Guid.Parse("99999999-5000-0000-0000-000000000402")),
            502,
        ...
        new(
            new DocumentUuid(Guid.Parse("99999999-5000-0000-0000-000000000403")),
            503,
        ...
        new(
            new DocumentUuid(Guid.Parse("99999999-5000-0000-0000-000000000404")),
            504,
    ...
    public async Task OneTimeSetUp()
    {
        ...
        await _context.SeedTermDescriptorAsync(
            Guid.Parse("99999999-5000-0000-0000-000000000501"),
            TermDescriptor
        );
