...
file static class MssqlIfMatchCascadeEtagTestSupport
{
...
public class Given_A_Mssql_Relational_Update_With_A_Stale_IfMatch_After_An_Identity_Cascade
{
    ...
    public async Task OneTimeSetUp()
    {
        ...
        var fixture = MssqlGeneratedDdlFixtureLoader.LoadFromRepositoryRelativePath(
            MssqlIfMatchCascadeEtagTestSupport.FixtureRelativePath
        );
    ...
    public async Task SetUp()
    {
        ...
        _serviceProvider = MssqlIfMatchCascadeEtagTestSupport.CreateServiceProvider();
    }
    ...
    public async Task It_returns_412_for_stale_IfMatch_after_a_student_identity_cascade_changes_resourcea_etag()
    {
        var createStudentResult = await ExecuteUpsertAsync(
            MssqlIfMatchCascadeEtagTestSupport.StudentResourceInfo,
        ...
        var createResourceAResult = await ExecuteUpsertAsync(
            MssqlIfMatchCascadeEtagTestSupport.ResourceAResourceInfo,
    ...
    )
    {
        ...
        return await repository.UpsertDocument(
            new UpsertRequest(
                ResourceInfo: resourceInfo,
                DocumentInfo: MssqlIfMatchCascadeEtagTestSupport.CreateDocumentInfo(
                    resourceInfo,
                    requestBody
                ),
