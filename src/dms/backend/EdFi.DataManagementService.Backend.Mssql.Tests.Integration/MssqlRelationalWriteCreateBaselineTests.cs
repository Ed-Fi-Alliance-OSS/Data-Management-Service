...
/// <summary>
/// SQL Server adapter for the shared <c>NoProfileFullSurfaceCreate</c> scenario. This suite owns only
/// the SQL Server provisioning, resolver registration, no-profile production-boundary invocation, and
...
public class Given_A_Mssql_Relational_Write_Create_Baseline_With_A_Focused_Stable_Key_Fixture
{
        ...
        scope
            ...
            .SetSelectedDataStore(
                new DataStore(
                    Id: 1,
                    DataStoreType: "test",
                    Name: "MssqlRelationalWriteCreateBaseline",
