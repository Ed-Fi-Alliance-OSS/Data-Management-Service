...
// DMS-1145 task 29a (MSSQL side) — concrete root reference (AcademicWeek -> School) link
// emission integration test. Uses the deterministic DeterministicLinkSlugResolver harness
// rather than wiring a real IApiSchemaProvider; the real resolver has unit coverage in
        ...
        serviceProvider
            ...
            .SetSelectedDmsInstance(
                new DmsInstance(
                    Id: 1,
                    InstanceType: "test",
                    InstanceName: "MssqlLinkInjection",
