...
public class Given_A_Mssql_DescriptorRead_Get_Request
{
    ...
    public async Task It_reads_descriptor_get_by_id_as_an_external_response_with_metadata_and_without_internal_fields()
    {
        var seed = new DescriptorReadSeed(
            DocumentUuid: new DocumentUuid(Guid.Parse("40000000-0000-0000-0000-000000000101")),
    ...
    {
        var seed = new DescriptorReadSeed(
            DocumentUuid: new DocumentUuid(Guid.Parse("40000000-0000-0000-0000-000000000102")),
            Namespace: "uri://ed-fi.org/SchoolTypeDescriptor",
            CodeValue: "Charter",
    ...
    {
        var seed = new DescriptorReadSeed(
            DocumentUuid: new DocumentUuid(Guid.Parse("40000000-0000-0000-0000-000000000103")),
        ...
        var result = await ExecuteGetByIdAsync(seed.DocumentUuid, "mssql-descriptor-get-wrong-resource");
    ...
    public async Task It_returns_not_implemented_when_descriptor_get_authorization_requires_filtering()
    {
        ...
        var result = await ExecuteGetByIdAsync(
            new DocumentUuid(Guid.Parse("40000000-0000-0000-0000-000000000104")),
            "mssql-descriptor-get-auth",
    ...
    public async Task It_treats_discriminator_mismatch_as_diagnostic_only()
    {
        ...
        var result = await ExecuteGetByIdAsync(seed.DocumentUuid, "mssql-descriptor-get-discriminator");
    ...
    public async Task It_returns_an_unknown_failure_when_the_selected_descriptor_document_has_no_descriptor_row()
    {
        ...
        var documentId = await MssqlDescriptorReadTestSupport.InsertDocumentAsync(
            _database,
            documentUuid,
            resourceKeyId
        );
    ...
    {
        var seed = new DescriptorReadSeed(
            DocumentUuid: new DocumentUuid(Guid.Parse("40000000-0000-0000-0000-000000000107")),
            Namespace: "uri://ed-fi.org/SchoolTypeDescriptor",
            CodeValue: "Private",
        ...
        serviceProvider
            ...
            .SetSelectedDmsInstance(
                new DmsInstance(
                    Id: 1,
                    InstanceType: "test",
                    InstanceName: "MssqlDescriptorReadGet",
