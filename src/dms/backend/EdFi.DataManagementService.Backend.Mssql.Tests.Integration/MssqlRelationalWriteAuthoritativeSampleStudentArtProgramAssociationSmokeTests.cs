...
public class Given_A_Mssql_Relational_Write_Smoke_With_The_Authoritative_Sample_StudentArtProgramAssociation_Fixture
{
        ...
        serviceProvider
            ...
            .SetSelectedDataStore(
                new DataStore(
                    Id: 1,
                    DataStoreType: "test",
                    Name: "MssqlRelationalWriteAuthoritativeSampleStudentArtProgramAssociation",
    ...
    private async Task<MssqlStudentArtProgramAssociationSeedData> SeedReferenceDataAsync()
    {
        ...
        var roboticsClubProgramDocumentId = await NextDocumentIdAsync();
    ...
    )
    {
        var row = (
            await _database.QueryRowsAsync(
                ...
                FROM [sample].[StudentArtProgramAssociation] association
                WHERE association.[DocumentUuid] = @documentUuid;
                """,
