...
[NonParallelizable]
public class Given_A_Mssql_Generated_Ddl_Apply_Harness_With_A_Focused_Stable_Key_Fixture
{
    ...
    public void It_can_read_engine_specific_column_defaults()
    {
        ...
        _schoolAddressCollectionItemDefault.Should().Contain("NEXT VALUE FOR");
    }
