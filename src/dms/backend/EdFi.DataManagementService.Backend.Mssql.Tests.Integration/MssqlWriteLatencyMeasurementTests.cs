...
/// <summary>
/// Measures warm, steady-state, end-to-end write latency against live SQL Server, which is this story's
...
public class Given_A_Mssql_Warm_Steady_State_Write_Latency_Measurement
{
        ...
        return await scope
            ...
            .UpdateDocumentById(
                new UpdateRequest(
                    ...
                    EdfiDoc: body,
                    Headers: [],
                    TraceId: new TraceId("mssql-write-latency-update"),
        ...
        return await scope
            ...
            .DeleteDocumentById(
                new DeleteRequest(
                    DocumentUuid: documentUuid,
                    ResourceInfo: _schoolResourceInfo,
                    TraceId: new TraceId("mssql-write-latency-delete"),
                    Headers: [],
                    MappingSet: _mappingSet
                )
            );
    ...
    private ServiceProvider CreateServiceProvider()
    {
        ...
        services.AddScoped<IRelationalWriteSessionFactory, MssqlRelationalWriteSessionFactory>();
