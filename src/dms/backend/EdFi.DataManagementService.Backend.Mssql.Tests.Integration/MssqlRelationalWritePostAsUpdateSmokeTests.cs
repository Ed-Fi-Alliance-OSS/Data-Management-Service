...
public class Given_A_Mssql_Relational_Post_Create_Race_With_The_Focused_Stable_Key_Fixture
{
    ...
    // reaching the gate fails the fixture instead of hanging the shard.
    ...
    public async Task OneTimeSetUp()
    {
        ...
        // hang the shard if the worker faulted, or if the gate ever stopped sitting on the write path,
