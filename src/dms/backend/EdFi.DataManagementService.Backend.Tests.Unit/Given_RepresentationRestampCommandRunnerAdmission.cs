...
public class Given_RepresentationRestampCommandRunnerAdmission
{
    ...
    {
        DocumentCacheAdministrativeCommandContracts
            .RequiresOfflineWriterAdmission(DocumentCacheAdministrativeCommand.RepresentationRestamp)
            .Should()
            .BeTrue();
        DocumentCacheAdministrativeCommandContracts
            .ExpectedCommandConfirmation(DocumentCacheAdministrativeCommand.RepresentationRestamp)
            .Should()
            .Be(DocumentCacheAdministrativeCommandConfirmation.RepresentationRestamp);
    ...
    public void It_admits_preview_without_confirmation_but_rejects_execute_without_exact_confirmation()
    {
        ...
        var execute = new DocumentCacheRepresentationRestampExecuteRequest(
            Target,
            Guid.NewGuid(),
            preview.OfflineWriterAdmission
        );
        DocumentCachePreflightClassifier
            .ClassifyCommandConfirmation(
                DocumentCacheAdministrativeCommand.RepresentationRestamp,
                Target,
                execute.Confirmation
            )!
            .Classification.Should()
            .Be(DocumentCacheAdministrativeCommandClassification.MissingCommandConfirmation);
    }
    ...
    {
        Action deserialize = () =>
            JsonSerializer.Deserialize<DocumentCacheOfflineWriterAdmission>("\"otherToken\"");
    ...
    public void It_binds_preview_and_execute_request_json_and_applies_their_admission_rules()
    {
        ...
        DocumentCachePreflightClassifier
            ...
            .Classification.Should()
            .Be(DocumentCacheAdministrativeCommandClassification.MismatchedCommandConfirmation);
    }
}
