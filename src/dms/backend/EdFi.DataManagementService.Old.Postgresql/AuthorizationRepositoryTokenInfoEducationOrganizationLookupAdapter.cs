...
public sealed class AuthorizationRepositoryTokenInfoEducationOrganizationLookupAdapter(
...
) : ITokenInfoEducationOrganizationLookup
{
    ...
    {
        return authorizationRepository.GetTokenInfoEducationOrganizations(educationOrganizationIds);
    }
}
