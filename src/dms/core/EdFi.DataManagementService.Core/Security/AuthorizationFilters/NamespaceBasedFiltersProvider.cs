...
/// </summary>
[AuthorizationStrategyName(AuthorizationStrategyNameConstants.NamespaceBased)]
public class NamespaceBasedFiltersProvider : AuthorizationFiltersProviderBase
{
    public NamespaceBasedFiltersProvider()
        : base(AuthorizationStrategyNameConstants.NamespaceBased) { }
