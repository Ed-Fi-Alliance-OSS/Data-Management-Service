...
{
    /// <summary>
    /// Feature flag to enable/disable JWT authentication in DMS Core
    /// </summary>
    public bool Enabled { get; set; } = false;

    /// <summary>
    /// List of client IDs enabled for JWT authentication (for gradual rollout)
    /// </summary>
    public List<string> EnabledForClients { get; set; } = [];
