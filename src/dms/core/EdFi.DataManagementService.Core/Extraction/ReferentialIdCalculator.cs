...
internal static class ReferentialIdCalculator
{
    ...
    /// </summary>
    public static readonly Guid EdFiUuidv5Namespace = ReferentialIdFactory.EdFiUuidv5Namespace;
    ...
    {
        return ReferentialIdFactory.Create(resourceInfo, documentIdentity);
    }
}
