...
/// <summary>
/// Provides caching for compiled JSON Schemas keyed by resource, method, and schema load identifier.
/// </summary>
internal interface ICompiledSchemaCache
{
    ...
    /// </summary>
    void Prime(ApiSchemaDocuments documents, Guid schemaLoadId);
}
