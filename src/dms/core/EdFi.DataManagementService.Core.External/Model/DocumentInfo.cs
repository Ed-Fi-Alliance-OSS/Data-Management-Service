...
public record DocumentInfo(
    ...
    /// <summary>
    /// A list of descriptor values extracted from the API document, including descriptor-valued members under
    /// document references when required by the relational write path.
    /// </summary>
