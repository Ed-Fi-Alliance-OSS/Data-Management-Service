...
public record AuthorizationPathway
{
    ...
    /// </summary>
    /// <param name="StudentUsi">Extracted from the request body. Has its default value if the request method is GET or DELETE.</param>
    /// <param name="SchoolId">Extracted from the request body. Has its default value if the request method is GET or DELETE.</param>
    public record StudentSchoolAssociation(StudentUsi? StudentUsi, EducationOrganizationId? SchoolId)
