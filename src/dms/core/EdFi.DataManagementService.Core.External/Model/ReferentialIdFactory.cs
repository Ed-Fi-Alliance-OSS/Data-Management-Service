...
/// <summary>
/// Shared helper for calculating deterministic referential identifiers from document identity values.
/// </summary>
public static class ReferentialIdFactory
{
    /// <summary>
    ...
    /// </summary>
    public static ReferentialId Create(BaseResourceInfo resourceInfo, DocumentIdentity documentIdentity)
    {
