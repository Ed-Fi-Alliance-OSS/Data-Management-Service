...
public class RelationshipsWithStudentsOnlyFiltersProviderTests
{
    [TestFixture]
    [Parallelizable]
    public class Given_Claim_Has_EducationOrganizations
    {
        ...
        public void Setup()
        {
            var filters = new RelationshipsWithStudentsOnlyFiltersProvider();
        ...
        {
            _expectedResult.Should().NotBeNull();
            _expectedResult!.AuthorizationStrategyName.Should().Be("RelationshipsWithStudentsOnly");
        }
    }
    ...
    public class Given_Claim_Has_No_EducationOrganizations
    {
        ...
        public void Should_Throw_AuthorizationException()
        {
            ...
            exception!
                .Message.Should()
                .Be(
                    "The API client has been given permissions on a resource that uses the 'RelationshipsWithStudentsOnly' authorization strategy but the client doesn't have any education organizations assigned."
                );
        }
    }
}
