...
public class EffectiveSchemaHashProviderTests
{
    ...
    public class Given_Known_Fixture_Schema : EffectiveSchemaHashProviderTests
    {
        ...
        // Last re-blessed for SchemaHashConstants.RelationalMappingVersion "v1" -> "v2", which is a
        // hashed manifest line: the removal of dms.Document / dms.ReferentialIdentity is the first
        // destructively schema-incompatible mapping change, so every effective schema hash moves.
