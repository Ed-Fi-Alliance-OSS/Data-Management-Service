...
public class EffectiveSchemaHashProviderTests
{
    ...
    public class Given_Known_Fixture_Schema : EffectiveSchemaHashProviderTests
    {
        ...
        // Last blessed for the RelationalMappingVersion v1 -> v2 bump (dms.Document dropped
        // identity stamp columns; dms.Descriptor gained ResourceKeyId and descriptor paging
        // re-rooted onto it).
