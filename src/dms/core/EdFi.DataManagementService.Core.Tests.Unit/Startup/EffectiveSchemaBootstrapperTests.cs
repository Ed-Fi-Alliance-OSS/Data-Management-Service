...
[TestFixture]
public class EffectiveSchemaBootstrapperTests
{
    ...
    [TestFixture]
    public class Given_Valid_Schema : EffectiveSchemaBootstrapperTests
    {
    ...
    [TestFixture]
    public class Given_Effective_Schema_Set_Initialization_Fails : EffectiveSchemaBootstrapperTests
    {
        private IApiSchemaProvider _mockSchemaProvider = null!;
        private IEffectiveApiSchemaProvider _mockEffectiveProvider = null!;
        private IEffectiveSchemaSetProvider _mockEffectiveSchemaSetProvider = null!;
    ...
    [TestFixture]
    public class Given_Schema_Loading_Fails : EffectiveSchemaBootstrapperTests
    {
        private IApiSchemaProvider _mockSchemaProvider = null!;
        private IEffectiveApiSchemaProvider _mockEffectiveProvider = null!;
        private IEffectiveSchemaSetProvider _mockEffectiveSchemaSetProvider = null!;
    ...
    [TestFixture]
    public class Given_Schema_Validation_Fails : EffectiveSchemaBootstrapperTests
    {
        private IApiSchemaProvider _mockSchemaProvider = null!;
        private IEffectiveApiSchemaProvider _mockEffectiveProvider = null!;
        private IEffectiveSchemaSetProvider _mockEffectiveSchemaSetProvider = null!;
    ...
    [TestFixture]
    public class Given_Cancellation_Is_Requested : EffectiveSchemaBootstrapperTests
    {
        private IApiSchemaProvider _mockSchemaProvider = null!;
        private IEffectiveApiSchemaProvider _mockEffectiveProvider = null!;
        private IEffectiveSchemaSetProvider _mockEffectiveSchemaSetProvider = null!;
        ...
        public async Task It_throws_OperationCanceledException_before_loading()
        {
            ...
            // Act
            Func<Task> act = async () => await _bootstrapper.InitializeAsync(cancelledToken);
        ...
        public async Task It_does_not_load_schema_when_cancelled()
        {
            ...
            try
            {
                await _bootstrapper.InitializeAsync(cancelledToken);
            }
