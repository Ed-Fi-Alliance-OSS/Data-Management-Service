...
public class AppSettings
{
    ...
    /// Correlation ID header or was generated by the server. Values longer than this limit are
    /// truncated before sanitization and logging. Defaults to 255 characters.
    /// </summary>
