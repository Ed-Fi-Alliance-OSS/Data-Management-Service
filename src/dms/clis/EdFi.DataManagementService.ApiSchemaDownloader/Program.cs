    ...
    public static class Program
    {
        private static async Task Main(string[] args)
        {
            ...
            _ = await result.WithParsedAsync(async options =>
            {
                ...
                var packagePath = await DownloadNuGetPackageAsync(
                    packageId,
                    packageVersion,
                    feedUrl,
                    outputDir
            ...
            static void ExtractApiSchemaJsonFromAssembly(
                string packageId,
                string packagePath,
                string outputDir
            )
            ...
            static async Task<string> DownloadNuGetPackageAsync(
                string packageId,
            ...
            )
            {
                ...
                var packageIdentity = new PackageIdentity(
                    packageId,
                    new NuGet.Versioning.NuGetVersion(packageVersion)
                );
