...
public class MetadataModuleTests
{
    ...
    [
        ...
        "GET /v3/apiClients/{id}/ownership int32",
        "PUT /v3/apiClients/{id}/ownership int32",
        "GET /v3/ownershipTokens/{id} int32",
        "PUT /v3/ownershipTokens/{id} int32",
    ...
    [
        ...
        "ApiClientOwnershipUpdateCommand.creatorOwnershipTokenId int32",
        "ApiClientOwnershipUpdateCommand.ownershipTokenIds int32",
        "ApiClientResponse.id int32",
        "ApiClientResponse.applicationId int32",
        "ApiClientResponse.creatorOwnershipTokenId int32",
        "ApiClientResponse.ownershipTokenIds int32",
