...
public class FailureResultsTests
{
    ...
    [Test]
    public void Unknown_returns_compliant_internal_server_error()
    {
    ...
    [Test]
    public void NotFound_returns_compliant_not_found()
    {
    ...
    [Test]
    public void BadRequest_returns_compliant_bad_request()
    {
        var (statusCode, contentType, body) = Inspect(
    ...
    [Test]
    public void DataValidation_returns_compliant_validation_failure_with_grouped_errors()
    {
    ...
    [Test]
    public void Forbidden_with_errors_returns_compliant_authorization_failure_using_errors_verbatim()
    {
        var (statusCode, contentType, body) = Inspect(
    ...
    /// </summary>
    [Test]
    public void Forbidden_with_detail_preserves_identity_provider_prefix()
    {
        var (statusCode, contentType, body) = Inspect(
            FailureResults.Forbidden("Registration is disabled.", CorrelationId)
        );
    ...
    [Test]
    public void Unauthorized_uses_problem_json_content_type()
    {
        var (statusCode, contentType, body) = Inspect(
    ...
    [Test]
    public void BadGateway_uses_problem_json_content_type()
    {
        var (statusCode, contentType, body) = Inspect(
