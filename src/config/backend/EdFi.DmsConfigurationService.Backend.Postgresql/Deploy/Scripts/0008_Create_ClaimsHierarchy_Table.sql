...
CREATE UNIQUE INDEX uq_ProjectName_Version ON ClaimsHierarchy USING btree (ProjectName, Version);
CREATE UNIQUE INDEX idx_ProjectName_Version ON ClaimsHierarchy USING btree (ProjectName, Version);
