...
public class ResourceClaimRepositorySortingTests
{
    ...
    [Test]
    public void IsDescending_returns_true_for_desc()
    {
        var query = new ResourceClaimQuery { Direction = "desc" };
        var method = typeof(ResourceClaimRepository).GetMethod(
            "IsDescending",
            System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static
        );
    ...
    [Test]
    public void IsDescending_returns_true_for_descending()
    {
        var query = new ResourceClaimQuery { Direction = "descending" };
        var method = typeof(ResourceClaimRepository).GetMethod(
            "IsDescending",
            System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static
        );
    ...
    [Test]
    public void IsDescending_is_case_insensitive()
    {
        var query = new ResourceClaimQuery { Direction = "DESC" };
        var method = typeof(ResourceClaimRepository).GetMethod(
            "IsDescending",
    ...
    [Test]
    public void IsDescending_returns_false_for_asc()
    {
        var query = new ResourceClaimQuery { Direction = "asc" };
        var method = typeof(ResourceClaimRepository).GetMethod(
            "IsDescending",
            System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static
        );
    ...
    [Test]
    public void IsDescending_returns_false_for_null()
    {
        var query = new ResourceClaimQuery { Direction = null };
        var method = typeof(ResourceClaimRepository).GetMethod(
            "IsDescending",
            System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static
        );
