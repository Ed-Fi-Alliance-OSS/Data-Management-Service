...
1. **Ed-Fi Data Management Service (DMS)** - An implementation of Ed-Fi Resources API, Ed-Fi Descriptors API, and Ed-Fi Discovery API, in `./src/dms`. In official product documentation this is called the "Ed-Fi API".
